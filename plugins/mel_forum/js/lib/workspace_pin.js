...
export class ModuleForumPin extends WorkspaceObject {
  constructor() {
    super();
  }
   ...
   * @type {string}
   * @default 'module-forum-news'
   * @readonly
   */
  get moduleId() {
    return 'module-forum-news';
  }

  /**
   * Id du loader
   * @type {string}
   * @default 'forum-pin-spinner-loader'
   * @readonly
   */
  get loaderId() {
    return 'forum-pin-spinner-loader';
  }
  ...
  /**
   * Lance le module
   * @returns {ModuleForumPin}
   * @static
   */
  static Start() {
    return new ModuleForumPin();
  }
}

ModuleForumPin.Start();
