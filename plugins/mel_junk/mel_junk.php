...
class mel_junk extends rcube_plugin
{
    ...
    public function render_box($p) {
        ...
        $attrib = [
          'id'    => 'mel_junk-box',
          'class' => "popupmenu propform",
          'role' => "dialog",
          'aria-labelledby' => "aria-label-listoptions"
        ];
        ...
        $rcmail->output->add_footer(html::div($attrib,
          $rcmail->output->form_tag(array('name' => 'mel_junkform', 'method' => 'post', 'action' => './', 'enctype' => 'multipart/form-data'),
            html::div('junk-body',
              html::div('checkboxes',
              html::div('junk_folder', $checkbox->show('junk_folder', ['id' => 'mel_junk_folder', 'class' => 'junk_folder', 'value' => 'junk_folder']) . html::label(['for' => 'mel_junk_folder', 'style' => 'vertical-align: text-top;'], $this->gettext('add to junk folder'))) .
                html::div('send_admin', $checkbox->show('send_admin', ['id' => 'mel_junk_send_admin', 'class' => 'send_admin', 'value' => 'send_admin']) . html::label(['for' => 'mel_junk_send_admin', 'style' => 'vertical-align: text-top;'], $this->gettext('send message to administrator')))
          )
            )
          )
        ));
