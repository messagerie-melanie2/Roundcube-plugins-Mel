...
*/
            'showalarms' => array(
                ...
                'value' => html::tag('input', array('id' => 'taskedit-showalarms', 'name' => 'alarm', 'type' => 'checkbox')),
            ),
        );
    ...
    function quickadd_form($attrib)
    {
        ...
        // PAMELA
        $button = html::tag('input', array('type' => 'submit', 'value' => $this->plugin->gettext('add'), 'title' => $this->plugin->gettext('createtask'), 'class' => 'button mainaction'));
