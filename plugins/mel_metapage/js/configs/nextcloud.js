...
nextcloud_document.addIcon("rss", "icon-mel-rss");
nextcloud_document.addIcon("news", "icon-mel-newspaper");
nextcloud_document.addIcon("survey", "icon-mel-sondage");
nextcloud_document.addIcon("start", "icon-mel-favorite");
nextcloud_document.addIcon("nextcloud", "icon-mel-folder");
nextcloud_document.addIcon("tasks", "icon-mel-survey");
