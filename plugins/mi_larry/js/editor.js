...
function rcube_text_editor(config, id)
{
  ...
  // full-featured editor
    ...
    $.extend(conf, {
      ...
      toolbar: 'undo redo | bold italic underline strikethrough | outdent indent | alignleft aligncenter alignright alignjustify'
        + ' | bullist numlist blockquote | forecolor backcolor | fontselect fontsizeselect'
        + ' | link unlink',
