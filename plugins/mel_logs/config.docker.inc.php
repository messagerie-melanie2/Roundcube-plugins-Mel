...
$rcmail_config['log_file'] = $_ENV['RC_MEL_LOGS_LOG_FILE'] ?? 'roundcube_mel.log';
...
$rcmail_config['mel_logs_level'] = $_ENV['RC_MEL_LOGS_LEVEL'] ?? 'TRACE|DEBUG|INFO|ERROR|WARN';

// Liste des utilisateurs en debug
$rcmail_config['mel_logs_debug_users'] = $_ENV['RC_MEL_LOGS_DEBUG_USERS'];

// Liste des utilisateurs en trace
$rcmail_config['mel_logs_trace_users'] = $_ENV['RC_MEL_LOGS_TRACE_USERS'];
