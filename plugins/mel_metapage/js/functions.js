...
function m_mp_Create()
{
    ...
    if (window.create_popUp === undefined)
    {
        ...
        let mail = `<div role="listitem" class="col-sd-4 col-md-4" title="${rcmail.gettext("mel_metapage.menu_create_help_email")}">` + button(rcmail.gettext("mel_metapage.a_mail"), "icon-mel-mail block", "rcmail.command('compose','',this,event)") + "</div>";
