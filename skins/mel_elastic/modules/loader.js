...
/**
 * Liste des classes de modules UI à charger par le `ModuleLoader`.
 *
 * @type {Array<new () => import('./core/ABaseModule.js').ABaseModule>}
 * @constant
 */
...
export class ModuleLoader extends ABaseLoader {
  /**
   * Instance unique du singleton, créée à la demande.
   *
   * @type {?ModuleLoader}
   */
  ...
  /**
   * Construit le chargeur avec la liste fixe des modules UI de `mel_elastic`.
   * Ne pas instancier directement — passer par {@link ModuleLoader.Instance}.
   */
  constructor() {
    super(MODULES);
  }
