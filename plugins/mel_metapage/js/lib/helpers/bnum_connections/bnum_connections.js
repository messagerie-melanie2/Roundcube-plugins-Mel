...
class BnumConnector {
   ...
   * @template T
   * @template Y
   * @param {Connector<T, Y>} connector Connecteur qui contient les informations pour faire le lien avec le back
   * @param {Object} param0
  ...
  static is_on_progress(data) {
    return data.has_error && data.error === 'Connector is in progress';
  }
}
