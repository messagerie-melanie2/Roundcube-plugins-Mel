window.rcmail &&
  rcmail.addEventListener('init', function (evt) {
    ...
    href +=
      '&_source=' + rcmail.env.annuaire_source + '&_action=plugin.annuaire';
    $('#taskbar a.button-addressbook').attr('href', href);
    $('#taskbar a.button-addressbook').attr(
      'onclick',
      "return rcmail.command('switch-addressbook','addressbook',this,event)",
    );
