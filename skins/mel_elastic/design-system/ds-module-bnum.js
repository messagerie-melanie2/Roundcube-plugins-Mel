...
class BnumElement extends HTMLElement {
  ...
  text(value) {
    if (value === undefined) return this.textContent || EMPTY_STRING$1;
  ...
  #_flushUpdates() {
    ...
    if (
      this.constructor.__CONFIG_UPDATE_ALL__ ??
  ...
  static _p_WriteAttributes(attrs) {
    if (Object.keys(attrs).length === 0) return EMPTY_STRING$1;
  ...
  return function (_target, context) {
    ...
    return {
      get() {
        ...
        if (val === EMPTY_STRING$1 || val === 'true') return true;
        if (val === null) return false;
        // Si c'est un nombre (on vérifie si la conversion est possible)
        const num = Number(val);
        if (val !== EMPTY_STRING$1 && !isNaN(num)) return num;
        return val;
      },
      set(value) {
...
function _setAttribute(instance, attributeName, value) {
  ...
  else instance.setAttribute(attributeName, value);
}
function _getAttribute(instance, attributeName) {
  if (instance?.attr) return instance.attr(attributeName);
  ...
  return class _____StCustomFire {
    static {
      ...
      __esDecorate(
        this,
        null,
        _static_tryInitEvent_decorators,
        {
          kind: 'method',
          name: 'tryInitEvent',
          static: true,
          private: false,
          access: {
            has: (obj) => 'tryInitEvent' in obj,
            get: (obj) => obj.tryInitEvent,
          },
          metadata: _metadata,
        },
        null,
...
let HTMLBnumBadge = (() => {
  ...
  (class extends _classSuper {
    ...
    #_update(force = false) {
      ...
      if (value !== EMPTY_STRING$1) this._p_addState(STATE_HAS_VALUE);
...
// --- Defaults & CSS Vars ---
const DEFAULT_CSS_VAR_ICON_MARGIN =
...
function renderChildren(child) {
  if (child == null || child === false || child === true) return EMPTY_STRING$1;
...
function _get(options) {
  ...
  if (!cache.has(listenerCacheKey)) {
    const event = circular ? new eventExports.JsCircularEvent() : new JsEvent();
...
const SYMBOLS = BnumElement.ConstructCSSStyleSheet(
  css_248z$r.replaceAll(`.${ICON_CLASS}`, ':host'),
);
...
let HTMLBnumIcon = (() => {
  ...
  var HTMLBnumIcon = class extends _classSuper {
    ...
    static {
      __setFunctionName(this, 'HTMLBnumIcon');
    }
    static {
      const _metadata =
        typeof Symbol === 'function' && Symbol.metadata
      ...
      __esDecorate(
        ...
        _oniconchanged_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'oniconchanged' in obj,
            get: (obj) => obj.oniconchanged,
            set: (obj, value) => {
              obj.oniconchanged = value;
            },
          },
          metadata: _metadata,
        },
        _oniconchanged_initializers,
    ...
    #oniconchanged_accessor_storage =
      (__runInitializers(this, ___extraInitializers),
      __runInitializers(this, _oniconchanged_initializers, void 0));
    /**
     * Événement déclenché lors du changement d'icône. (via la propriété icon)
     */
    get oniconchanged() {
      return this.#oniconchanged_accessor_storage;
    }
    set oniconchanged(value) {
      this.#oniconchanged_accessor_storage = value;
    }
    /**
    ...
    get icon() {
      const icon =
        this.textContent?.trim?.() || this.data(DATA_ICON) || EMPTY_STRING$1;
      return icon;
    }
    /**
...
//#region Template
const TEMPLATE$g = h('div', {
  class: CLASS_WRAPPER,
  children: [
    h('span', { class: CLASS_SLOT, children: h('slot', {}) }),
    h(HTMLBnumIcon, { hidden: 'true', class: CLASS_ICON }),
  ],
});
//#endregion Template
...
let HTMLBnumButton = (() => {
  ...
  var HTMLBnumButton = class extends _classSuper {
    ...
    static {
      ...
      _private__onLoadingChange_decorators = [
      ...
      __esDecorate(
        this,
        (_private__ui_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_ui_accessor_storage;
            },
            '#_ui',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_ui_accessor_storage = value;
            },
            '#_ui',
            'set',
          ),
        ...
        _private__ui_initializers,
        _private__ui_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _onloadingstatechange_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'onloadingstatechange' in obj,
            get: (obj) => obj.onloadingstatechange,
            set: (obj, value) => {
              obj.onloadingstatechange = value;
            },
          },
          metadata: _metadata,
        },
        _onloadingstatechange_initializers,
      ...
      __esDecorate(
        ...
        _oniconchange_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'oniconchange' in obj,
            get: (obj) => obj.oniconchange,
            set: (obj, value) => {
              obj.oniconchange = value;
            },
          },
          metadata: _metadata,
        },
        _oniconchange_initializers,
        _oniconchange_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        ...
        {
          kind: 'accessor',
          name: 'oniconpropchange',
          static: false,
          private: false,
          access: {
            has: (obj) => 'oniconpropchange' in obj,
            get: (obj) => obj.oniconpropchange,
            set: (obj, value) => {
              obj.oniconpropchange = value;
            },
          },
          metadata: _metadata,
        },
        _oniconpropchange_initializers,
        _oniconpropchange_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        ...
        {
          kind: 'accessor',
          name: 'onvariationchange',
          static: false,
          private: false,
          access: {
            has: (obj) => 'onvariationchange' in obj,
            get: (obj) => obj.onvariationchange,
            set: (obj, value) => {
              obj.onvariationchange = value;
            },
          },
          metadata: _metadata,
        },
        _onvariationchange_initializers,
        _onvariationchange_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _linkedClickEvent_decorators,
        {
          kind: 'accessor',
          name: 'linkedClickEvent',
          static: false,
          private: false,
          access: {
            has: (obj) => 'linkedClickEvent' in obj,
            get: (obj) => obj.linkedClickEvent,
            set: (obj, value) => {
              obj.linkedClickEvent = value;
            },
          },
          metadata: _metadata,
        },
        _linkedClickEvent_initializers,
        _linkedClickEvent_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__onLinkedClick_descriptor = {
          value: __setFunctionName(function (click) {
            ...
            if (elementToClick) elementToClick.click();
              ...
              if (elements) elements.click();
                ...
                throw new Error(
                  "L'attribut 'click' ne référence aucun élément.",
                );
            }
          }, '#_onLinkedClick'),
        }),
        _private__onLinkedClick_decorators,
        {
          ...
          private: true,
          access: {
            has: (obj) => #_onLinkedClick in obj,
            get: (obj) => obj.#_onLinkedClick,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__onLoadingChange_descriptor = {
          value: __setFunctionName(function (state) {
            return { state };
          }, '#_onLoadingChange'),
        }),
        _private__onLoadingChange_decorators,
        {
          kind: 'method',
          name: '#_onLoadingChange',
          static: false,
          private: true,
          access: {
            has: (obj) => #_onLoadingChange in obj,
            get: (obj) => obj.#_onLoadingChange,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        null,
        __p_onLoadingChange_decorators,
        {
          kind: 'method',
          name: '_p_onLoadingChange',
          static: false,
          private: false,
          access: {
            has: (obj) => '_p_onLoadingChange' in obj,
            get: (obj) => obj._p_onLoadingChange,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        ...
        _setLoading_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'setLoading' in obj,
            get: (obj) => obj.setLoading,
          },
          metadata: _metadata,
        },
        null,
    ...
    //#region Private fields
    #_renderScheduler =
      (__runInitializers(this, _instanceExtraInitializers), null);
    #_lastClick = null;
    #_ui_accessor_storage = __runInitializers(
      this,
      _private__ui_initializers,
      void 0,
    );
     ...
     */
    get #_ui() {
      return _private__ui_descriptor.get.call(this);
    }
    set #_ui(value) {
      return _private__ui_descriptor.set.call(this, value);
    }
    #onloadingstatechange_accessor_storage =
      (__runInitializers(this, _private__ui_extraInitializers),
      __runInitializers(this, _onloadingstatechange_initializers, void 0));
    /**
     * Événement déclenché lors du changement d'état de chargement.
     */
    get onloadingstatechange() {
      return this.#onloadingstatechange_accessor_storage;
    }
    set onloadingstatechange(value) {
      this.#onloadingstatechange_accessor_storage = value;
    }
    #oniconchange_accessor_storage =
      (__runInitializers(this, _onloadingstatechange_extraInitializers),
      __runInitializers(this, _oniconchange_initializers, void 0));
    /**
     * Événement déclenché lors du changement d'icône.
     */
    get oniconchange() {
      return this.#oniconchange_accessor_storage;
    }
    set oniconchange(value) {
      this.#oniconchange_accessor_storage = value;
    }
    #oniconpropchange_accessor_storage =
      (__runInitializers(this, _oniconchange_extraInitializers),
      __runInitializers(this, _oniconpropchange_initializers, void 0));
    /**
     * Événement déclenché lors du changement de propriété de l'icône.
     */
    get oniconpropchange() {
      return this.#oniconpropchange_accessor_storage;
    }
    set oniconpropchange(value) {
      this.#oniconpropchange_accessor_storage = value;
    }
    #onvariationchange_accessor_storage =
      (__runInitializers(this, _oniconpropchange_extraInitializers),
      __runInitializers(this, _onvariationchange_initializers, void 0));
    /**
     * Événement déclenché lors du changement de variation du bouton.
     */
    get onvariationchange() {
      return this.#onvariationchange_accessor_storage;
    }
    set onvariationchange(value) {
      this.#onvariationchange_accessor_storage = value;
    }
    #linkedClickEvent_accessor_storage =
      (__runInitializers(this, _onvariationchange_extraInitializers),
      __runInitializers(this, _linkedClickEvent_initializers, void 0));
    /** Événement déclenché lors du clic sur le bouton. */
    get linkedClickEvent() {
      return this.#linkedClickEvent_accessor_storage;
    }
    set linkedClickEvent(value) {
      this.#linkedClickEvent_accessor_storage = value;
    }
    /**
    ...
    set icon(value) {
      if (this.alreadyLoaded)
        this.oniconchange.call(
          value || EMPTY_STRING$1,
          this.icon || EMPTY_STRING$1,
        );
      if (typeof value === 'string' && /^[\w-]+$/.test(value)) {
        const fromAttribute = false;
    ...
    #_updateDOM() {
      ...
      if (isLoading) this._p_addState(STATE_LOADING$1);
      if (isDisabled || isLoading) this._p_addState(STATE_DISABLED$2);
      // Gestion de l'icône
     ...
     */
    get #_onLinkedClick() {
      return _private__onLinkedClick_descriptor.value;
    }
    /**
     ...
     */
    get #_onLoadingChange() {
      return _private__onLoadingChange_descriptor.value;
    }
    ...
    static _p_Create(buttonClass, options) {
      ...
      for (const { prop, attr, isBool } of BUTTON_ATTRIBUTE_MAP) {
        const val = prop === 'iconMargin' ? finalMargin : config[prop];
...
let BnumDateUtils = (() => {
  ...
  return class BnumDateUtils {
    static {
      ...
      __esDecorate(
        this,
        (_static_private__parse_descriptor = {
          value: __setFunctionName(function (dateString, format) {
        ...
        _static_private__parse_decorators,
        {
          kind: 'method',
          name: '#_parse',
          static: true,
          private: true,
          access: { has: (obj) => #_parse in obj, get: (obj) => obj.#_parse },
          metadata: _metadata,
        },
        null,
        _staticExtraInitializers,
     ...
     */
    static get #_parse() {
      return _static_private__parse_descriptor.value;
    }
    /**
...
let HTMLBnumDate = (() => {
  ...
  (class extends _classSuper {
    ...
    static {
      __setFunctionName(this, 'HTMLBnumDate');
    }
    static {
      const _metadata =
        typeof Symbol === 'function' && Symbol.metadata
      ...
      __esDecorate(
        ...
        _formatEvent_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'formatEvent' in obj,
            get: (obj) => obj.formatEvent,
            set: (obj, value) => {
              obj.formatEvent = value;
            },
          },
          metadata: _metadata,
        },
        _formatEvent_initializers,
        _formatEvent_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__format_descriptor = {
          value: __setFunctionName(function (locale) {
        ...
        _private__format_decorators,
        {
          kind: 'method',
          name: '#_format',
          static: false,
          private: true,
          access: { has: (obj) => #_format in obj, get: (obj) => obj.#_format },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
    ...
    _ =
      ...
      __runInitializers(this, ___initializers, void 0));
    ...
    #_renderFrameId;
    #formatEvent_accessor_storage = __runInitializers(
      this,
      _formatEvent_initializers,
      void 0,
    );
     ...
     */
    get formatEvent() {
      return this.#formatEvent_accessor_storage;
    }
    set formatEvent(value) {
      this.#formatEvent_accessor_storage = value;
    }
    /**
    ...
    get localeElement() {
      return (
        __classPrivateFieldGet(this._, _classThis, 'f', _HTMLBnumDate__LOCALES)[
          this.#_locale
        ] ||
        this.#_locale ||
        __classPrivateFieldGet(this._, _classThis, 'f', _HTMLBnumDate__LOCALES)[
    ...
    _p_preload() {
      ...
      this.addEventListener(EVENT_ATTRIBUTE_UPDATED, (e) => {
        this.trigger(
          `${EVENT_ATTRIBUTE_UPDATED}:${e.detail.property}`,
          e.detail,
        );
      });
    ...
    get #_format() {
      return _private__format_descriptor.value;
    }
    //#endregion Private Methods
    //#region Statics
    /**
    ...
    static Create(dateInput, options) {
      const el = document
        ...
        .condAttr(
          ...
          options?.startFormat ?? EMPTY_STRING$1,
        );
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        ...
        _private__render_decorators,
        {
          kind: 'method',
          name: '#_render',
          static: false,
          private: true,
          access: { has: (obj) => #_render in obj, get: (obj) => obj.#_render },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
     ...
     */
    get #_render() {
      return _private__render_descriptor.value;
    }
    /**
...
let HTMLBnumButtonIcon = (() => {
  let _classDecorators = [
    Define({ styles: css_248z$n, tag: TAG_ICON_BUTTON, template: TEMPLATE$f }),
    Observe('click'),
  ];
  let _classDescriptor;
  let _classExtraInitializers = [];
  ...
  var HTMLBnumButtonIcon = class extends _classSuper {
    ...
    static {
      const _metadata =
        typeof Symbol === 'function' && Symbol.metadata
          ...
          : void 0;
      ___decorators = [Self];
      _private__linkedClickEvent_decorators = [
        Listener(OnLinkedClickEventInitializer, { lazy: false }),
      ];
      __esDecorate(
        this,
        (_private__linkedClickEvent_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_linkedClickEvent_accessor_storage;
            },
            '#_linkedClickEvent',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_linkedClickEvent_accessor_storage = value;
            },
            '#_linkedClickEvent',
            'set',
          ),
        ...
        {
          kind: 'accessor',
          name: '#_linkedClickEvent',
          static: false,
          private: true,
          access: {
            has: (obj) => #_linkedClickEvent in obj,
            get: (obj) => obj.#_linkedClickEvent,
            set: (obj, value) => {
              obj.#_linkedClickEvent = value;
            },
          },
          metadata: _metadata,
        },
        _private__linkedClickEvent_initializers,
    ...
    _ = __runInitializers(this, ___initializers, void 0);
    #_linkedClickEvent_accessor_storage =
      (__runInitializers(this, ___extraInitializers),
      __runInitializers(this, _private__linkedClickEvent_initializers, void 0));
    get #_linkedClickEvent() {
      return _private__linkedClickEvent_descriptor.get.call(this);
    }
    set #_linkedClickEvent(value) {
      return _private__linkedClickEvent_descriptor.set.call(this, value);
    }
    /**
     * Référence vers l'élément icône à l'intérieur du bouton.
     *
  ...
  return h(HTMLBnumFragment, {
    children: [
      h('label', {
        ...
        children: [
          h('span', {
            id: ID_HINT_TEXT_LABEL,
            class: 'label-container--label',
            children: h('slot', {}),
          }),
          h('span', {
            id: ID_HINT_TEXT_HINT,
            class: 'label-container--hint hint-label',
            children: h('slot', { name: SLOT_HINT }),
          }),
        ],
      }),
      h('div', {
          ...
          h('div', {
            ...
            children: [
              h('div', {
                ...
                children: [
                  addonInner,
                  h(HTMLBnumIcon, { id: ID_INPUT_ICON }),
                  h('input', {
                    class: 'input-like',
                    id: ID_INPUT$1,
              ...
              h(HTMLBnumButton, {
                ...
                children: h('slot', { name: SLOT_BUTTON }),
              }),
            ],
          }),
          h('span', {
            ...
            children: [
              h(HTMLBnumIcon, { id: ID_STATE_ICON }),
              h('span', {
                id: ID_SUCCESS_TEXT,
                class: CLASS_STATE_TEXT_SUCCESS,
                children: h('slot', {
                  name: SLOT_SUCCESS,
                  children: TEXT_VALID_INPUT,
                }),
              }),
              h('span', {
                id: ID_ERROR_TEXT,
                class: CLASS_STATE_TEXT_ERROR,
                children: h('slot', {
                  name: SLOT_ERROR,
                  children: TEXT_INVALID_INPUT,
                }),
              }),
            ],
          }),
...
const INPUT_STYLE_STATES =
  BnumElementInternal.ConstructCSSStyleSheet(css_248z$k);
...
let HTMLBnumInput = (() => {
  ...
  (class extends _classSuper {
    ...
    static {
      __setFunctionName(this, 'HTMLBnumInput');
    }
    static {
      _HTMLBnumInput__CreateSlotElement =
        function _HTMLBnumInput__CreateSlotElement(node, slotName, content) {
          if (content) {
    ...
    static {
      ...
      __esDecorate(
        ...
        _onButtonClicked_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'onButtonClicked' in obj,
            get: (obj) => obj.onButtonClicked,
            set: (obj, value) => {
              obj.onButtonClicked = value;
            },
          },
          metadata: _metadata,
        },
        _onButtonClicked_initializers,
      ...
      __esDecorate(
        this,
        null,
        __p_inputValueChangedCallback_decorators,
        {
          kind: 'method',
          name: '_p_inputValueChangedCallback',
          static: false,
          private: false,
          access: {
            has: (obj) => '_p_inputValueChangedCallback' in obj,
            get: (obj) => obj._p_inputValueChangedCallback,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__setFormValue_descriptor = {
          value: __setFunctionName(function (value) {
            this._p_internal.setFormValue(value);
            return ATresult.Ok();
          }, '#_setFormValue'),
        }),
        _private__setFormValue_decorators,
        {
          kind: 'method',
          name: '#_setFormValue',
          static: false,
          private: true,
          access: {
            has: (obj) => #_setFormValue in obj,
            get: (obj) => obj.#_setFormValue,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__internalSetValidity_descriptor = {
          value: __setFunctionName(function (flags, message, anchor) {
            return this._p_internal.setValidity(flags, message, anchor);
          }, '#_internalSetValidity'),
        }),
        _private__internalSetValidity_decorators,
        {
          kind: 'method',
          name: '#_internalSetValidity',
          static: false,
          private: true,
          access: {
            has: (obj) => #_internalSetValidity in obj,
            get: (obj) => obj.#_internalSetValidity,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__safeCheckValidity_descriptor = {
          value: __setFunctionName(function () {
            return this.#_ui.input.checkValidity();
          }, '#_safeCheckValidity'),
        }),
        _private__safeCheckValidity_decorators,
        {
          kind: 'method',
          name: '#_safeCheckValidity',
          static: false,
          private: true,
          access: {
            has: (obj) => #_safeCheckValidity in obj,
            get: (obj) => obj.#_safeCheckValidity,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__dispatchEvent_descriptor = {
          value: __setFunctionName(function (e) {
            this.dispatchEvent(e);
            return ATresult.Ok();
          }, '#_dispatchEvent'),
        }),
        _private__dispatchEvent_decorators,
        {
          kind: 'method',
          name: '#_dispatchEvent',
          static: false,
          private: true,
          access: {
            has: (obj) => #_dispatchEvent in obj,
            get: (obj) => obj.#_dispatchEvent,
          },
          metadata: _metadata,
        },
        null,
     ...
     */
    #_initValue =
      (__runInitializers(this, _instanceExtraInitializers), EMPTY_STRING$1);
    //#endregion Private fields
    //#region Getters/Setters
    /** Référence à la classe HTMLBnumInput */
    _ = __runInitializers(this, ___initializers, void 0);
    #_ui_accessor_storage =
      (__runInitializers(this, ___extraInitializers),
      __runInitializers(this, _private__ui_initializers, void 0));
    get #_ui() {
      return _private__ui_descriptor.get.call(this);
    }
    set #_ui(value) {
    ...
    #onButtonClicked_accessor_storage =
      (__runInitializers(this, _private__ui_extraInitializers),
      __runInitializers(this, _onButtonClicked_initializers, void 0));
    /**
     * Permet d'écouter le clic sur le bouton interne.
     */
    get onButtonClicked() {
      return this.#onButtonClicked_accessor_storage;
    }
    set onButtonClicked(value) {
      this.#onButtonClicked_accessor_storage = value;
    }
    #name_accessor_storage =
      (__runInitializers(this, _onButtonClicked_extraInitializers),
      __runInitializers(this, _name_initializers, EMPTY_STRING$1));
    // -- Formulaire --
    /**
    ...
    constructor() {
      ...
      this.#_initValue =
        this.getAttribute(ATTRIBUTE_DATA_VALUE) ?? EMPTY_STRING$1;
    }
    /**
    ...
    formDisabledCallback(disabled) {
      if (disabled) this.setAttribute(ATTRIBUTE_DISABLED$1, 'disabled');
      this.#_sync();
    }
    // -- Helper --
    /**
    ...
    #_update() {
      ...
      if (button_icon !== null) {
        ...
        else if (btnValue === EMPTY_STRING$1) this._p_addState(STATE_OBI);
      }
    ...
    #_sync() {
      ...
      input.disabled =
        this.hasAttribute(ATTRIBUTE_DISABLED$1) ||
        this._p_hasState(STATE_DISABLED$2);
    ...
    #_setValidity() {
      ...
      if (isManualError) {
        ...
        this.#_safeCheckValidity().match({
          Ok: (isValid) => {
            const isSuccess =
              isValid && this.#_ui.input.validationMessage === EMPTY_STRING$1;
            if (isSuccess) {
              this.#_internalSetValidity({});
            } else {
              this.#_internalSetValidity(
    ...
    #_syncValidationUI(isManualError) {
      ...
      const isError =
        isManualError || (hasNativeError && !input.validity.valid);
      const isSuccess =
        !isManualError && hasNativeError && input.validity.valid;
      ...
      if (hasState) {
        this._p_addStates(
          STATE_STATE$1,
          isSuccess ? STATE_SUCCESS : STATE_ERROR$1,
        );
        const successText =
        ...
        this.shadowRoot.querySelector(`#${slotTextId} slot`).innerText =
          validationText;
     ...
     */
    get #_setFormValue() {
      return _private__setFormValue_descriptor.value;
    }
    /**
     ...
     * @returns Résultat de l'opération.
     */
    get #_internalSetValidity() {
      return _private__internalSetValidity_descriptor.value;
    }
    /**
     * Fait une vérification sécurisée de la validité de l'input.
     * @returns Résultat de l'opération avec la validité.
     */
    get #_safeCheckValidity() {
      return _private__safeCheckValidity_descriptor.value;
    }
    /**
     ...
     */
    get #_dispatchEvent() {
      return _private__dispatchEvent_descriptor.value;
    }
    /**
    ...
    static {
      ...
      __esDecorate(
        ...
        __p_preload_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => '_p_preload' in obj,
            get: (obj) => obj._p_preload,
          },
          metadata: _metadata,
        },
        null,
...
var css_248z$i =
  ':host .container{position:relative}:host #input-search-actions-container{display:flex;position:absolute;right:50px;top:5px}:host #input-search-actions-container #input-clear-button{display:none}:host(:state(value)) #input-search-actions-container #input-clear-button{display:inline-block}';
...
//#region Template
const TEMPLATE$e = h('div', {
  id: ID_ACTIONS_CONTAINER,
  part: ID_ACTIONS_CONTAINER,
  children: [
    h(HTMLBnumButtonIcon, { id: ID_CLEAR_BUTTON, children: 'close' }),
    h('slot', { name: SLOT_ACTIONS }),
  ],
});
//#endregion Template
/**
...
let HTMLBnumInputSearch = (() => {
  let _classDecorators = [
    Define({ template: Render(TEMPLATE$e), tag: TAG_INPUT_SEARCH }),
  ];
  let _classDescriptor;
  let _classExtraInitializers = [];
  let _classThis;
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        ...
        _onclear_initializers,
        _onclear_extraInitializers,
      );
      __esDecorate(
        this,
        null,
      ...
      __esDecorate(
        this,
        null,
        __triggerEventSearch_decorators,
        {
          kind: 'method',
          name: '_triggerEventSearch',
          static: false,
          private: false,
          access: {
            has: (obj) => '_triggerEventSearch' in obj,
            get: (obj) => obj._triggerEventSearch,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__onKeyDown_descriptor = {
          value: __setFunctionName(function () {
            return (e) => {
        ...
        _private__onKeyDown_decorators,
        {
          kind: 'method',
          name: '#_onKeyDown',
          static: false,
          private: true,
          access: {
            has: (obj) => #_onKeyDown in obj,
            get: (obj) => obj.#_onKeyDown,
          },
          metadata: _metadata,
        },
        null,
    ...
    #onclear_accessor_storage =
      (__runInitializers(this, _private__ui_extraInitializers),
      __runInitializers(this, _onclear_initializers, void 0));
    //#endregion Private fields
    /**
     * Événement déclenché lors du clic sur le bouton de vidage du champ de recherche.
     */
    get onclear() {
      return this.#onclear_accessor_storage;
    }
    set onclear(value) {
      this.#onclear_accessor_storage = value;
    }
    //#region Lifecycle
    /**
    ...
    get #_onKeyDown() {
      return _private__onKeyDown_descriptor.value;
    }
    //#endregion Private Methods
    //#region Static Methods
    /**
  ...
  return class CheckedChangeEvent extends _classSuper {
    static {
      ...
      __esDecorate(
        ...
        _checked_initializers,
        _checked_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        ...
        _caller_initializers,
        _caller_extraInitializers,
      );
      if (_metadata)
        Object.defineProperty(this, Symbol.metadata, {
          enumerable: true,
    ...
    #value_accessor_storage = __runInitializers(
      this,
      _value_initializers,
      void 0,
    );
    ...
    #checked_accessor_storage =
      (__runInitializers(this, _name_extraInitializers),
      __runInitializers(this, _checked_initializers, void 0));
    get checked() {
    ...
    #caller_accessor_storage =
      (__runInitializers(this, _checked_extraInitializers),
      __runInitializers(this, _caller_initializers, void 0));
    get caller() {
      return this.#caller_accessor_storage;
    }
    set caller(value) {
      this.#caller_accessor_storage = value;
    }
    constructor(options) {
      super(
        `${options.caller.constructor.TAG}:change`,
 ...
 * @internal
 */
const TEMPLATE$d = h(HTMLBnumFragment, {
  children: [
    h('input', { type: 'radio', id: ID_INPUT, class: 'radio' }),
    h('label', {
      part: 'label',
      for: 'radio',
      class: 'radio__label',
      children: [
        h('span', {
          class: 'radio__label--legend',
          children: h('slot', { id: 'legend' }),
        }),
        h('span', {
          class: 'radio--hint label-container--hint',
          children: h('slot', { id: 'hint', name: 'hint' }),
        }),
      ],
    }),
  ],
...
let HTMLBnumRadio = (() => {
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      _private__fireChange_decorators = [
      ...
      __esDecorate(
        this,
        null,
        _static__p_observedAttributes_decorators,
        {
          kind: 'method',
          name: '_p_observedAttributes',
          static: true,
          private: false,
          access: {
            has: (obj) => '_p_observedAttributes' in obj,
            get: (obj) => obj._p_observedAttributes,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__legend_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_legend_accessor_storage;
            },
            '#_legend',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_legend_accessor_storage = value;
            },
            '#_legend',
            'set',
          ),
        }),
        _private__legend_decorators,
        {
          kind: 'accessor',
          name: '#_legend',
          static: false,
        ...
        _private__legend_initializers,
        _private__legend_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _onstatechange_decorators,
        {
          kind: 'accessor',
          name: 'onstatechange',
          static: false,
          private: false,
          access: {
            has: (obj) => 'onstatechange' in obj,
            get: (obj) => obj.onstatechange,
            set: (obj, value) => {
        ...
        _onstatechange_initializers,
        _onstatechange_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__hint_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_hint_accessor_storage;
            },
            '#_hint',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_hint_accessor_storage = value;
            },
            '#_hint',
            'set',
          ),
        }),
        _private__hint_decorators,
        {
          kind: 'accessor',
          name: '#_hint',
          static: false,
        ...
        _private__hint_initializers,
        _private__hint_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        __p_buildDOM_decorators,
        {
          kind: 'method',
          name: '_p_buildDOM',
          static: false,
          private: false,
          access: {
            has: (obj) => '_p_buildDOM' in obj,
            get: (obj) => obj._p_buildDOM,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__update_descriptor = {
          value: __setFunctionName(function (name, newVal, onactions) {
        ...
        _private__update_decorators,
        {
          kind: 'method',
          name: '#_update',
          static: false,
          private: true,
          access: { has: (obj) => #_update in obj, get: (obj) => obj.#_update },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        this,
        (_private__fireChange_descriptor = {
          value: __setFunctionName(function (ev) {
            ev.stopPropagation();
        ...
        _private__fireChange_decorators,
        {
          ...
          private: true,
          access: {
            has: (obj) => #_fireChange in obj,
            get: (obj) => obj.#_fireChange,
          },
          metadata: _metadata,
        },
        null,
    ...
    static formAssociated =
      (__runInitializers(_classThis, _staticExtraInitializers), true);
    #_ui_accessor_storage =
      (__runInitializers(this, _instanceExtraInitializers),
      __runInitializers(this, _private__ui_initializers, void 0));
    //#endregion Constants
    ...
    #value_accessor_storage =
      (__runInitializers(this, _name_extraInitializers),
      __runInitializers(this, _value_initializers, EMPTY_STRING$1));
    /**
    ...
    #checked_accessor_storage =
      (__runInitializers(this, _value_extraInitializers),
      __runInitializers(this, _checked_initializers, true));
    /**
    ...
    #disabled_accessor_storage =
      (__runInitializers(this, _checked_extraInitializers),
      __runInitializers(this, _disabled_initializers, false));
    /**
    ...
    #_legend_accessor_storage =
      (__runInitializers(this, _disabled_extraInitializers),
      __runInitializers(this, _private__legend_initializers, EMPTY_STRING$1));
    /**
     ...
     */
    get #_legend() {
      return _private__legend_descriptor.get.call(this);
    }
    set #_legend(value) {
      return _private__legend_descriptor.set.call(this, value);
    }
    #onstatechange_accessor_storage =
      (__runInitializers(this, _private__legend_extraInitializers),
      __runInitializers(this, _onstatechange_initializers, void 0));
    /**
     * Appelé lorsque l'état de l'élément change
     */
    get onstatechange() {
      return this.#onstatechange_accessor_storage;
    }
    set onstatechange(value) {
      this.#onstatechange_accessor_storage = value;
    }
    #_hint_accessor_storage =
      (__runInitializers(this, _onstatechange_extraInitializers),
      __runInitializers(this, _private__hint_initializers, EMPTY_STRING$1));
    /**
     ...
     */
    get #_hint() {
      return _private__hint_descriptor.get.call(this);
    }
    set #_hint(value) {
      return _private__hint_descriptor.set.call(this, value);
    }
    /**
     ...
     */
    get #_update() {
      return _private__update_descriptor.value;
    }
    /**
     ...
     */
    get #_fireChange() {
      return _private__fireChange_descriptor.value;
    }
    /**
...
const TEMPLATE$c = h('div', {
  class: 'bnum-select__container',
  children: [
    h('label', {
      id: 'select-label',
      ...
      children: [
        h('span', {
          class: 'bnum-select__container__label--legend label-container--label',
          children: h('slot', { name: 'label' }),
        }),
        h('span', {
          class: 'bnum-select__container__label--hint label-container--hint',
          children: h('slot', { name: 'hint' }),
        }),
      ],
    }),
    h('div', {
...
let HTMLBnumSelect = (() => {
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      _private__legend_decorators = [Data({ setter: false })];
      _private__hint_decorators = [Data({ setter: false })];
      _private__defaultValue_decorators = [
        Data('default-value', { setter: false }),
      ];
      _private__defaultText_decorators = [
      ...
      __esDecorate(
        this,
        (_private__defaultValue_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_defaultValue_accessor_storage;
            },
            '#_defaultValue',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_defaultValue_accessor_storage = value;
            },
            '#_defaultValue',
            'set',
          ),
        ...
        _private__defaultValue_decorators,
        {
          ...
          private: true,
          access: {
            has: (obj) => #_defaultValue in obj,
            get: (obj) => obj.#_defaultValue,
            set: (obj, value) => {
        ...
        _private__defaultValue_initializers,
        _private__defaultValue_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__defaultText_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_defaultText_accessor_storage;
            },
            '#_defaultText',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_defaultText_accessor_storage = value;
            },
            '#_defaultText',
            'set',
          ),
        ...
        _private__defaultText_decorators,
        {
          ...
          private: true,
          access: {
            has: (obj) => #_defaultText in obj,
            get: (obj) => obj.#_defaultText,
            set: (obj, value) => {
              obj.#_defaultText = value;
            },
          },
          metadata: _metadata,
        },
        _private__defaultText_initializers,
        _private__defaultText_extraInitializers,
      );
      __esDecorate(
        this,
        null,
      ...
      __esDecorate(
        ...
        _noLegend_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'noLegend' in obj,
            get: (obj) => obj.noLegend,
            set: (obj, value) => {
              obj.noLegend = value;
            },
          },
        ...
        _noLegend_initializers,
        _noLegend_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        __obserse_decorators,
        {
          kind: 'method',
          name: '_obserse',
          static: false,
          private: false,
          access: {
            has: (obj) => '_obserse' in obj,
            get: (obj) => obj._obserse,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__scheduleMoveOptions_descriptor = {
          value: __setFunctionName(function () {
            this.#_moveOptions();
          }, '#_scheduleMoveOptions'),
        }),
        _private__scheduleMoveOptions_decorators,
        {
          kind: 'method',
          name: '#_scheduleMoveOptions',
          static: false,
          private: true,
          access: {
            has: (obj) => #_scheduleMoveOptions in obj,
            get: (obj) => obj.#_scheduleMoveOptions,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__tryInitValue_descriptor = {
          value: __setFunctionName(function ({
            ...
            if (isNullOrUndefined$1(this.#_initValue))
              this.#_initValue =
                this.#_defaultValue ??
                (ignoreSelectedValue ? null : this.value);
            return ATresult.Ok();
          }, '#_tryInitValue'),
        }),
        _private__tryInitValue_decorators,
        {
          kind: 'method',
          name: '#_tryInitValue',
          static: false,
          private: true,
          access: {
            has: (obj) => #_tryInitValue in obj,
            get: (obj) => obj.#_tryInitValue,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__fireSelect_descriptor = {
          value: __setFunctionName(function (event) {
            return { innerEvent: event, caller: this };
          }, '#_fireSelect'),
        }),
        _private__fireSelect_decorators,
        {
          kind: 'method',
          name: '#_fireSelect',
          static: false,
          private: true,
          access: {
            has: (obj) => #_fireSelect in obj,
            get: (obj) => obj.#_fireSelect,
          },
          metadata: _metadata,
        },
        null,
    ...
    #_legend_accessor_storage =
      (__runInitializers(this, _private__ui_extraInitializers),
      __runInitializers(this, _private__legend_initializers, null));
    /**
    ...
    #_hint_accessor_storage =
      (__runInitializers(this, _private__legend_extraInitializers),
      __runInitializers(this, _private__hint_initializers, null));
    /**
    ...
    #_defaultValue_accessor_storage =
      (__runInitializers(this, _private__hint_extraInitializers),
      __runInitializers(this, _private__defaultValue_initializers, null));
    /**
     ...
     */
    get #_defaultValue() {
      return _private__defaultValue_descriptor.get.call(this);
    }
    set #_defaultValue(value) {
      return _private__defaultValue_descriptor.set.call(this, value);
    }
    #_defaultText_accessor_storage =
      (__runInitializers(this, _private__defaultValue_extraInitializers),
      __runInitializers(this, _private__defaultText_initializers, null));
    /**
     ...
     */
    get #_defaultText() {
      return _private__defaultText_descriptor.get.call(this);
    }
    set #_defaultText(value) {
      return _private__defaultText_descriptor.set.call(this, value);
    }
    #name_accessor_storage =
      (__runInitializers(this, _private__defaultText_extraInitializers),
      __runInitializers(this, _name_initializers, EMPTY_STRING$1));
    /**
     * Nom de l'input
     */
    ...
    #noLegend_accessor_storage =
      (__runInitializers(this, _name_extraInitializers),
      __runInitializers(this, _noLegend_initializers, true));
    /**
     * Si l'attribut `no-legend` est actif, la légende ne s'affichera pas (seulement pour les lecteurs d'écrans).
     */
    get noLegend() {
      return this.#noLegend_accessor_storage;
    }
    set noLegend(value) {
      this.#noLegend_accessor_storage = value;
    }
    /**
     * Valeur du select
     */
    ...
    get #_scheduleMoveOptions() {
      return _private__scheduleMoveOptions_descriptor.value;
    }
    #_moveOptions() {
    ...
    get #_tryInitValue() {
      return _private__tryInitValue_descriptor.value;
    }
    get #_setFormValue() {
      return _private__setFormValue_descriptor.value;
    }
    get #_fireSelect() {
      return _private__fireSelect_descriptor.value;
    }
    #_onInnerSelect() {
 ...
 * @internal
 */
const TEMPLATE$b = h(HTMLBnumFragment, {
  children: [
    h('input', { id: 'native-input', type: 'checkbox', role: 'switch' }),
    h('label', {
      class: 'checkbox__label label-container hint-label',
      for: 'native-input',
      children: [
        h('span', {
          class: 'checkbox__label--legend label-container--label ',
          children: h('slot', { id: 'legend' }),
        }),
        h('span', {
          id: 'active-text',
          class:
            'checkbox__label__desc checkbox__label__desc--ok label-container--hint',
          children: h('slot', {
            name: 'activeText',
            children: TEXT_ACTIVE_DEFAULT,
          }),
        }),
        h('span', {
          id: 'inactive-text',
          class:
            'checkbox__label__desc checkbox__label__desc--no label-container--hint',
          children: h('slot', {
            name: 'inactiveText',
            children: TEXT_INACTIVE_DEFAULT,
          }),
        }),
      ],
    }),
    h('span', {
      class: 'checkbox__label--hint hint-label label-container--hint',
      children: h('slot', { id: ID_HINT$1, name: ID_HINT$1 }),
    }),
    h('div', {
      class: 'checkbox__state state',
      children: [
        h(HTMLBnumIcon, { id: 'icon' }),
        h('span', { id: ID_VALIDITY_TEXT }),
      ],
    }),
  ],
});
...
let HTMLBnumSwitch = (() => {
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        this,
        (_private__noHint_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_noHint_accessor_storage;
            },
            '#_noHint',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_noHint_accessor_storage = value;
            },
            '#_noHint',
            'set',
          ),
        }),
        _private__noHint_decorators,
        {
          kind: 'accessor',
          name: '#_noHint',
          static: false,
        ...
        _private__noHint_initializers,
        _private__noHint_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _oncheckedchange_decorators,
        {
          kind: 'accessor',
          ...
          private: false,
          access: {
            has: (obj) => 'oncheckedchange' in obj,
            get: (obj) => obj.oncheckedchange,
            set: (obj, value) => {
              obj.oncheckedchange = value;
            },
          },
          metadata: _metadata,
        },
        _oncheckedchange_initializers,
        _oncheckedchange_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__checkValidity_descriptor = {
          value: __setFunctionName(function () {
            return this.#_ui.input.checkValidity();
          }, '#_checkValidity'),
        }),
        _private__checkValidity_decorators,
        {
          kind: 'method',
          name: '#_checkValidity',
          static: false,
          private: true,
          access: {
            has: (obj) => #_checkValidity in obj,
            get: (obj) => obj.#_checkValidity,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__reportValidity_descriptor = {
          value: __setFunctionName(function () {
            return this.#_ui.input.reportValidity();
          }, '#_reportValidity'),
        }),
        _private__reportValidity_decorators,
        {
          kind: 'method',
          ...
          private: true,
          access: {
            has: (obj) => #_reportValidity in obj,
            get: (obj) => obj.#_reportValidity,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__change_descriptor = {
          value: __setFunctionName(function (event) {
            this.checked = this.#_ui.input.checked;
            return { inner: event, caller: this };
          }, '#_change'),
        }),
        _private__change_decorators,
        {
          kind: 'method',
          name: '#_change',
          static: false,
          private: true,
          access: { has: (obj) => #_change in obj, get: (obj) => obj.#_change },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        this,
        (_private__setText_descriptor = {
          value: __setFunctionName(function () {
            if (
              this.#_ui.validityText.textContent !==
              this.#_ui.input.validationMessage
            )
              this.#_ui.validityText.textContent =
                this.#_ui.input.validationMessage;
        ...
        _private__setText_decorators,
        {
          ...
          private: true,
          access: {
            has: (obj) => #_setText in obj,
            get: (obj) => obj.#_setText,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__setInternalError_descriptor = {
          value: __setFunctionName(function () {
        ...
        _private__setInternalError_decorators,
        {
          kind: 'method',
          name: '#_setInternalError',
          static: false,
          private: true,
          access: {
            has: (obj) => #_setInternalError in obj,
            get: (obj) => obj.#_setInternalError,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__setValidity_descriptor = {
          value: __setFunctionName(function () {
            if (this.checkValidity()) {
              this._p_internal.setValidity({});
            }
        ...
        _private__setValidity_decorators,
        {
          kind: 'method',
          name: '#_setValidity',
          static: false,
          private: true,
          access: {
            has: (obj) => #_setValidity in obj,
            get: (obj) => obj.#_setValidity,
          },
          metadata: _metadata,
        },
        null,
    ...
    #checked_accessor_storage =
      (__runInitializers(this, _private__ui_extraInitializers),
      __runInitializers(this, _checked_initializers, false));
    //#endregion Private Fields
    ...
    #name_accessor_storage =
      (__runInitializers(this, _checked_extraInitializers),
      __runInitializers(this, _name_initializers, undefined));
    /**
    ...
    #value_accessor_storage =
      (__runInitializers(this, _name_extraInitializers),
      __runInitializers(this, _value_initializers, 'on'));
    /**
    ...
    #required_accessor_storage =
      (__runInitializers(this, _disabled_extraInitializers),
      __runInitializers(this, _required_initializers, false));
    /**
    ...
    #helper_accessor_storage =
      (__runInitializers(this, _required_extraInitializers),
      __runInitializers(this, _helper_initializers, false));
    /**
     ...
     */
    get helper() {
      return this.#helper_accessor_storage;
    }
    set helper(value) {
      this.#helper_accessor_storage = value;
    }
    #_legend_accessor_storage =
      (__runInitializers(this, _helper_extraInitializers),
      __runInitializers(this, _private__legend_initializers, void 0));
    /**
    ...
    #_hint_accessor_storage =
      (__runInitializers(this, _private__legend_extraInitializers),
      __runInitializers(this, _private__hint_initializers, void 0));
    /**
    ...
    #_noHint_accessor_storage =
      (__runInitializers(this, _private__hint_extraInitializers),
      __runInitializers(this, _private__noHint_initializers, void 0));
    /**
     ...
     */
    get #_noHint() {
      return _private__noHint_descriptor.get.call(this);
    }
    set #_noHint(value) {
      return _private__noHint_descriptor.set.call(this, value);
    }
    #oncheckedchange_accessor_storage =
      (__runInitializers(this, _private__noHint_extraInitializers),
      __runInitializers(this, _oncheckedchange_initializers, void 0));
    /**
     ...
     */
    get oncheckedchange() {
      return this.#oncheckedchange_accessor_storage;
    }
    set oncheckedchange(value) {
      this.#oncheckedchange_accessor_storage = value;
    }
     ...
     */
    _p_update(name, oldVal, newVal) {
      if (newVal === EMPTY_STRING$1) newVal = ARIA_TRUE;
      if (oldVal === newVal) return;
      switch (name) {
     ...
     */
    get #_checkValidity() {
      return _private__checkValidity_descriptor.value;
    }
    /**
     ...
     */
    get #_reportValidity() {
      return _private__reportValidity_descriptor.value;
    }
    /**
     ...
     */
    get #_change() {
      return _private__change_descriptor.value;
    }
    /**
     ...
     */
    get #_setText() {
      return _private__setText_descriptor.value;
    }
    /**
     ...
     * @private
     */
    get #_setInternalError() {
      return _private__setInternalError_descriptor.value;
    }
    /**
     ...
     */
    get #_setValidity() {
      return _private__setValidity_descriptor.value;
    }
    /**
     * Synchronise les attributs entre l'élément hôte et l'input interne.
     *
...
var css_248z$e =
  ':host #action{display:none}:host(:state(action)) #action{display:block}:host(:state(action)) #avatar{display:none}';

const TEMPLATE$a = h(HTMLBnumFragment, {
  children: [
    h('span', { id: 'avatar', children: h('slot', { name: 'avatar' }) }),
    h('span', { id: 'action', children: h('slot', { name: 'action' }) }),
  ],
});
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        ...
        _onEnter_initializers,
        _onEnter_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        ...
        _onLeave_initializers,
        _onLeave_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        __handleOnHover_decorators,
        {
          kind: 'method',
          name: '_handleOnHover',
          static: false,
          private: false,
          access: {
            has: (obj) => '_handleOnHover' in obj,
            get: (obj) => obj._handleOnHover,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        ...
        __handleOnLeave_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => '_handleOnLeave' in obj,
            get: (obj) => obj._handleOnLeave,
          },
          metadata: _metadata,
        },
        null,
    ...
    #onEnter_accessor_storage =
      (__runInitializers(this, _instanceExtraInitializers),
      __runInitializers(this, _onEnter_initializers, void 0));
    get onEnter() {
      return this.#onEnter_accessor_storage;
    }
    set onEnter(value) {
      this.#onEnter_accessor_storage = value;
    }
    #onLeave_accessor_storage =
      (__runInitializers(this, _onEnter_extraInitializers),
      __runInitializers(this, _onLeave_initializers, void 0));
    get onLeave() {
      return this.#onLeave_accessor_storage;
    }
    set onLeave(value) {
      this.#onLeave_accessor_storage = value;
    }
    constructor() {
      super();
    ...
    _handleOnMouseEnter() {
      if (this.onEnter.haveEvents()) this.onEnter.call(this);
      this._p_addState('action');
    }
    _handleOnMouseLeave() {
      if (this.onLeave.haveEvents()) this.onLeave.call(this);
      this._p_removeState('action');
    }
    static Create({ avatar = null, action = null } = {}) {
      const node = document.createElement(this.TAG);
      if (avatar) {
        if (!avatar.hasAttribute('slot')) avatar.setAttribute('slot', 'avatar');
        node.appendChild(avatar);
      }
      if (action) {
        if (!action.hasAttribute('slot')) action.setAttribute('slot', 'action');
...
var css_248z$d =
  '@keyframes rotate360{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}:host{background-color:var(--bnum-card-item-background-color,var(--bnum-color-surface,#f6f6f7));cursor:var(--bnum-card-item-cursor,pointer);display:var(--bnum-card-item-display,block);padding:var(--bnum-card-item-padding,5px 15px);user-select:none;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;width:calc(var(--bnum-card-item-width-percent, 100%) - var(--bnum-card-item-width-modifier, 0))}:host(:hover){background-color:var(--bnum-card-item-background-color-hover,var(--bnum-color-surface-hover,#eaeaea))}:host(:active){background-color:var(--bnum-card-item-background-color-active,var(--bnum-color-surface-active,#dfdfdf))}:host(:disabled),:host(:state(disabled)),:host([disabled]){cursor:not-allowed;opacity:.6;pointer-events:none}';
...
let HTMLBnumCardItem = (() => {
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        ...
        _onitemclicked_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'onitemclicked' in obj,
            get: (obj) => obj.onitemclicked,
            set: (obj, value) => {
              obj.onitemclicked = value;
            },
          },
          metadata: _metadata,
        },
        _onitemclicked_initializers,
        _onitemclicked_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        __p_attach_decorators,
        {
          kind: 'method',
          name: '_p_attach',
          static: false,
          private: false,
          access: {
            has: (obj) => '_p_attach' in obj,
            get: (obj) => obj._p_attach,
          },
          metadata: _metadata,
        },
        null,
    ...
    #onitemclicked_accessor_storage = __runInitializers(
      this,
      _onitemclicked_initializers,
      void 0,
    );
     ...
     */
    get onitemclicked() {
      return this.#onitemclicked_accessor_storage;
    }
    set onitemclicked(value) {
      this.#onitemclicked_accessor_storage = value;
    }
    //#endregion Fields
    //#region Lifecycle
    /**
...
//#endregion Global Constants
//#region Template
const AGENDA = h(HTMLBnumFragment, {
  children: [
    h('span', { class: CLASS_DAY + ' bold' }),
    h('div', {
      class: CLASS_HORIZONTAL,
      children: [
        h('div', {
          class: CLASS_BLOCK,
          children: [
            h('span', { class: CLASS_HOUR + ' bold' }),
            h('div', {
              class: CLASS_VERTICAL,
              children: [
                h('span', {
                  class: CLASS_TITLE + ' bold-500',
                  children: [
                    h('slot', { id: SLOT_TITLE$1, name: SLOT_TITLE$1 }),
                    h('div', { class: CLASS_TITLE_OVERRIDE, hidden: true }),
                  ],
                }),
                h('span', {
                  class: CLASS_LOCATION,
                  children: [
                    h('slot', { id: SLOT_LOCATION, name: SLOT_LOCATION }),
                    h('div', { class: CLASS_LOCATION_OVERRIDE, hidden: true }),
                  ],
                }),
              ],
            }),
        ...
        h('span', {
          class: CLASS_ACTION,
          children: [
            h('slot', { id: SLOT_ACTION, name: SLOT_ACTION }),
            h('div', { class: CLASS_ACTION_OVERRIDE, hidden: true }),
          ],
        }),
      ],
    }),
    h(HTMLBnumIcon, {
      class: CLASS_PRIVATE_ICON,
      hidden: true,
      children: ICON_PRIVATE,
    }),
  ],
});
//#endregion Template
...
let HTMLBnumCardItemAgenda = (() => {
  var _HTMLBnumCardItemAgenda__TryGetAgendaDate,
    _HTMLBnumCardItemAgenda__tryGetAgendaDates;
  let _classDecorators = [
    Define({
  ...
  (class extends _classSuper {
    ...
    static {
      __setFunctionName(this, 'HTMLBnumCardItemAgenda');
    }
    static {
      ((_HTMLBnumCardItemAgenda__TryGetAgendaDate =
        function _HTMLBnumCardItemAgenda__TryGetAgendaDate(val, selector) {
        ...
        (_HTMLBnumCardItemAgenda__tryGetAgendaDates =
          function _HTMLBnumCardItemAgenda__tryGetAgendaDates(...options) {
            return options.map((option) =>
              __classPrivateFieldGet(
                ...
                'm',
                _HTMLBnumCardItemAgenda__TryGetAgendaDate,
              ).call(this, option.val, option.selector),
            );
          }));
    }
    static {
      ...
      _onstartdefineaction_decorators = [
        Listener(NoInitListener, { circular: true }),
      ];
      ...
      _private__startDateFormat_decorators = [
        Data('start-date-format', NO_SETTER),
      ];
      ...
      __esDecorate(
        ...
        {
          kind: 'accessor',
          name: 'onstartdefineaction',
          static: false,
          private: false,
          access: {
            has: (obj) => 'onstartdefineaction' in obj,
            get: (obj) => obj.onstartdefineaction,
            set: (obj, value) => {
              obj.onstartdefineaction = value;
            },
          },
          metadata: _metadata,
        },
        _onstartdefineaction_initializers,
        _onstartdefineaction_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__baseDate_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_baseDate_accessor_storage;
            },
            '#_baseDate',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_baseDate_accessor_storage = value;
            },
            '#_baseDate',
            'set',
          ),
        }),
        _private__baseDate_decorators,
        {
          kind: 'accessor',
          name: '#_baseDate',
          static: false,
          private: true,
          access: {
            has: (obj) => #_baseDate in obj,
            get: (obj) => obj.#_baseDate,
            set: (obj, value) => {
              obj.#_baseDate = value;
            },
          },
        ...
        _private__baseDate_initializers,
        _private__baseDate_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__baseDateFormat_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_baseDateFormat_accessor_storage;
            },
            '#_baseDateFormat',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_baseDateFormat_accessor_storage = value;
            },
            '#_baseDateFormat',
            'set',
          ),
        }),
        _private__baseDateFormat_decorators,
        {
          kind: 'accessor',
          name: '#_baseDateFormat',
          static: false,
          private: true,
          access: {
            has: (obj) => #_baseDateFormat in obj,
            get: (obj) => obj.#_baseDateFormat,
            set: (obj, value) => {
              obj.#_baseDateFormat = value;
            },
          },
          metadata: _metadata,
        },
        _private__baseDateFormat_initializers,
        _private__baseDateFormat_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__startDate_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_startDate_accessor_storage;
            },
            '#_startDate',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_startDate_accessor_storage = value;
            },
            '#_startDate',
            'set',
          ),
        }),
        _private__startDate_decorators,
        {
          kind: 'accessor',
          name: '#_startDate',
          static: false,
          private: true,
          access: {
            has: (obj) => #_startDate in obj,
            get: (obj) => obj.#_startDate,
            set: (obj, value) => {
              obj.#_startDate = value;
            },
          },
          metadata: _metadata,
        },
        _private__startDate_initializers,
        _private__startDate_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__startDateFormat_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_startDateFormat_accessor_storage;
            },
            '#_startDateFormat',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_startDateFormat_accessor_storage = value;
            },
            '#_startDateFormat',
            'set',
          ),
        ...
        {
          kind: 'accessor',
          name: '#_startDateFormat',
          static: false,
          private: true,
          access: {
            has: (obj) => #_startDateFormat in obj,
            get: (obj) => obj.#_startDateFormat,
            set: (obj, value) => {
              obj.#_startDateFormat = value;
            },
          },
          metadata: _metadata,
        },
        _private__startDateFormat_initializers,
        _private__startDateFormat_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__endDate_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_endDate_accessor_storage;
            },
            '#_endDate',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_endDate_accessor_storage = value;
            },
            '#_endDate',
            'set',
          ),
        }),
        _private__endDate_decorators,
        {
          kind: 'accessor',
          name: '#_endDate',
          static: false,
          private: true,
          access: {
            has: (obj) => #_endDate in obj,
            get: (obj) => obj.#_endDate,
            set: (obj, value) => {
              obj.#_endDate = value;
            },
          },
        ...
        _private__endDate_initializers,
        _private__endDate_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__endDateFormat_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_endDateFormat_accessor_storage;
            },
            '#_endDateFormat',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_endDateFormat_accessor_storage = value;
            },
            '#_endDateFormat',
            'set',
          ),
        }),
        _private__endDateFormat_decorators,
        {
          kind: 'accessor',
          name: '#_endDateFormat',
          static: false,
          private: true,
          access: {
            has: (obj) => #_endDateFormat in obj,
            get: (obj) => obj.#_endDateFormat,
            set: (obj, value) => {
              obj.#_endDateFormat = value;
            },
          },
          metadata: _metadata,
        },
        _private__endDateFormat_initializers,
        _private__endDateFormat_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__title_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_title_accessor_storage;
            },
            '#_title',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_title_accessor_storage = value;
            },
            '#_title',
            'set',
          ),
        }),
        _private__title_decorators,
        {
          kind: 'accessor',
          name: '#_title',
          static: false,
        ...
        _private__title_initializers,
        _private__title_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__location_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_location_accessor_storage;
            },
            '#_location',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_location_accessor_storage = value;
            },
            '#_location',
            'set',
          ),
        }),
        _private__location_decorators,
        {
          kind: 'accessor',
          name: '#_location',
          static: false,
          private: true,
          access: {
            has: (obj) => #_location in obj,
            get: (obj) => obj.#_location,
            set: (obj, value) => {
              obj.#_location = value;
            },
          },
        ...
        _private__location_initializers,
        _private__location_extraInitializers,
      );
      __esDecorate(
        null,
        (_classDescriptor = { value: _classThis }),
    ...
    #onstartdefineaction_accessor_storage =
      (__runInitializers(this, _private__ui_extraInitializers),
      __runInitializers(this, _onstartdefineaction_initializers, void 0));
    /**
    ...
    get onstartdefineaction() {
      return this.#onstartdefineaction_accessor_storage;
    }
    set onstartdefineaction(value) {
      this.#onstartdefineaction_accessor_storage = value;
    }
    #_baseDate_accessor_storage =
      (__runInitializers(this, _onstartdefineaction_extraInitializers),
      __runInitializers(this, _private__baseDate_initializers, EMPTY_STRING$1));
    get #_baseDate() {
      return _private__baseDate_descriptor.get.call(this);
    }
    set #_baseDate(value) {
      return _private__baseDate_descriptor.set.call(this, value);
    }
    #_baseDateFormat_accessor_storage =
      (__runInitializers(this, _private__baseDate_extraInitializers),
      __runInitializers(
        this,
        _private__baseDateFormat_initializers,
        FORMAT_DATE_DEFAULT,
    ...
    get #_baseDateFormat() {
      return _private__baseDateFormat_descriptor.get.call(this);
    }
    set #_baseDateFormat(value) {
      return _private__baseDateFormat_descriptor.set.call(this, value);
    }
    #_startDate_accessor_storage =
      (__runInitializers(this, _private__baseDateFormat_extraInitializers),
      __runInitializers(
        this,
        _private__startDate_initializers,
        EMPTY_STRING$1,
    ...
    get #_startDate() {
      return _private__startDate_descriptor.get.call(this);
    }
    set #_startDate(value) {
      return _private__startDate_descriptor.set.call(this, value);
    }
    #_startDateFormat_accessor_storage =
      (__runInitializers(this, _private__startDate_extraInitializers),
      __runInitializers(
        this,
        _private__startDateFormat_initializers,
    ...
    get #_startDateFormat() {
      return _private__startDateFormat_descriptor.get.call(this);
    }
    set #_startDateFormat(value) {
      return _private__startDateFormat_descriptor.set.call(this, value);
    }
    #_endDate_accessor_storage =
      (__runInitializers(this, _private__startDateFormat_extraInitializers),
      __runInitializers(this, _private__endDate_initializers, EMPTY_STRING$1));
    get #_endDate() {
      return _private__endDate_descriptor.get.call(this);
    }
    set #_endDate(value) {
      return _private__endDate_descriptor.set.call(this, value);
    }
    #_endDateFormat_accessor_storage =
      (__runInitializers(this, _private__endDate_extraInitializers),
      __runInitializers(
        this,
        _private__endDateFormat_initializers,
        FORMAT_DATE_TIME_DEFAULT,
    ...
    get #_endDateFormat() {
      return _private__endDateFormat_descriptor.get.call(this);
    }
    set #_endDateFormat(value) {
      return _private__endDateFormat_descriptor.set.call(this, value);
    }
    #_title_accessor_storage =
      (__runInitializers(this, _private__endDateFormat_extraInitializers),
      __runInitializers(this, _private__title_initializers, null));
    get #_title() {
      return _private__title_descriptor.get.call(this);
    }
    set #_title(value) {
      return _private__title_descriptor.set.call(this, value);
    }
    #_location_accessor_storage =
      (__runInitializers(this, _private__title_extraInitializers),
      __runInitializers(this, _private__location_initializers, null));
    get #_location() {
      return _private__location_descriptor.get.call(this);
    }
    set #_location(value) {
      return _private__location_descriptor.set.call(this, value);
    }
    /**
    ...
    set startDate(value) {
      if (typeof value === 'string') {
        value =
          BnumDateUtils.parse(value, this.#_startDateFormat) ?? new Date();
      }
      ...
      element.formatEvent.add(EVENT_DEFAULT, (param) => {
        ...
        const date =
          typeof param.date === 'string'
            ? (BnumDateUtils.parse(param.date, element.format) ?? param.date)
            : param.date;
    ...
    #_requestShedulerAction(element, { forceCall = false } = {}) {
      this.#_shedulerAction ??= new Scheduler((innerElement) =>
        this.#_updateAction(innerElement),
      );
    ...
    #_requestShedulerTitle(element) {
      this.#_shedulerTitle ??= new Scheduler((innerElement) =>
        this.#_updateTitle(innerElement),
      );
    ...
    #_requestShedulerLocation(element) {
      this.#_shedulerLocation ??= new Scheduler((innerElement) =>
        this.#_updateLocation(innerElement),
      );
    ...
    static Create(
      ...
      if (mode) node.setAttribute(ATTRIBUTE_MODE$1, mode);
      if (action) {
    ...
    static FromEvent(
      ...
      const [startDate, endDate] = __classPrivateFieldGet(
        this,
        _classThis,
        'm',
        _HTMLBnumCardItemAgenda__tryGetAgendaDates,
      ...
      const title =
        agendaEvent?.title ?? titleSelector?.(agendaEvent) ?? EMPTY_STRING$1;
      const location =
        agendaEvent?.location ??
        locationSelector?.(agendaEvent) ??
        EMPTY_STRING$1;
...
//#endregion Global Constants
//#region Template
const TEMPLATE$9 = h(HTMLBnumFragment, {
  children: [
    h('div', {
      class: CLASS_MAIN_CONTENT,
      part: CLASS_MAIN_CONTENT,
      children: [
        h('div', {
          class: CLASS_SENDER,
          part: CLASS_SENDER,
          children: [
            h('slot', { id: ID_SENDER_SLOT, name: SLOT_SENDER_NAME }),
            h('span', {
        ...
        h('div', {
          ...
          part: CLASS_SUBJECT,
          children: [
            h('slot', { id: ID_SUBJECT_SLOT, name: SLOT_SUBJECT_NAME }),
            h('span', {
    ...
    h('div', {
      class: CLASS_DATE,
      children: [
        h('slot', { id: ID_DATE_SLOT, name: SLOT_DATE_NAME }),
        h('span', {
          class: PART_DATE_OVERRIDE,
          part: PART_DATE_OVERRIDE,
          hidden: true,
          children: h(HTMLBnumDate, { id: ID_DATE_ELEMENT_OVERRIDE }),
        }),
      ],
    }),
  ],
...
let HTMLBnumCardItemMail = (() => {
  let _classDecorators = [
    Define({
      tag: TAG_CARD_ITEM_MAIL,
      template: render(TEMPLATE$9, NO_DEFAULT),
    }),
    UpdateAll(),
  ];
  let _classDescriptor;
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        ...
        _onsubjectchanged_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'onsubjectchanged' in obj,
            get: (obj) => obj.onsubjectchanged,
            set: (obj, value) => {
              obj.onsubjectchanged = value;
            },
          },
          metadata: _metadata,
        },
        _onsubjectchanged_initializers,
        _onsubjectchanged_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _onsenderchanged_decorators,
        {
          kind: 'accessor',
          name: 'onsenderchanged',
          static: false,
          private: false,
          access: {
            has: (obj) => 'onsenderchanged' in obj,
            get: (obj) => obj.onsenderchanged,
            set: (obj, value) => {
              obj.onsenderchanged = value;
            },
          },
          metadata: _metadata,
        },
        _onsenderchanged_initializers,
        _onsenderchanged_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _ondatechanged_decorators,
        {
          kind: 'accessor',
          name: 'ondatechanged',
          static: false,
          private: false,
          access: {
            has: (obj) => 'ondatechanged' in obj,
            get: (obj) => obj.ondatechanged,
            set: (obj, value) => {
              obj.ondatechanged = value;
            },
          },
          metadata: _metadata,
        },
        _ondatechanged_initializers,
        _ondatechanged_extraInitializers,
      );
      __esDecorate(
        null,
        null,
    ...
    _ =
      (__runInitializers(this, _private__ui_extraInitializers),
      __runInitializers(this, ___initializers, void 0));
    #onsubjectchanged_accessor_storage =
      (__runInitializers(this, ___extraInitializers),
      __runInitializers(this, _onsubjectchanged_initializers, void 0));
    /**
     ...
     */
    get onsubjectchanged() {
      return this.#onsubjectchanged_accessor_storage;
    }
    set onsubjectchanged(value) {
      this.#onsubjectchanged_accessor_storage = value;
    }
    #onsenderchanged_accessor_storage =
      (__runInitializers(this, _onsubjectchanged_extraInitializers),
      __runInitializers(this, _onsenderchanged_initializers, void 0));
    /**
     ...
     */
    get onsenderchanged() {
      return this.#onsenderchanged_accessor_storage;
    }
    set onsenderchanged(value) {
      this.#onsenderchanged_accessor_storage = value;
    }
    #ondatechanged_accessor_storage =
      (__runInitializers(this, _onsenderchanged_extraInitializers),
      __runInitializers(this, _ondatechanged_initializers, void 0));
    /**
     ...
     */
    get ondatechanged() {
      return this.#ondatechanged_accessor_storage;
    }
    set ondatechanged(value) {
      this.#ondatechanged_accessor_storage = value;
    }
    /**
    ...
    get #_lazyDateOverrideElement() {
      return (this.#_dateOverrideElement ??= (() => {
        const existingDateElement = this.#_queryById(
    ...
    #_updateSender(content) {
      ...
      if (content === SYMBOL_RESET$2) {
        ...
        else this.#_ui.overriderSender.replaceChildren(content);
    ...
    #_updateSubject(content) {
      ...
      else this.#_ui.overriderSubject.replaceChildren(content);
      // On cache le slot, on montre l'override
  ...
  children: h('a', {
    ...
    children: [
      h('span', {
        class: 'container',
        children: [
          h('slot', { id: ID_SLOT_ICON, name: SLOT_NAME_ICON }),
          h(HTMLBnumIcon, { class: CLASS_ICON_TITLE, hidden: true }),
        ],
      }),
      h('span', {
        class: 'container',
        children: [
          h('slot', { id: ID_SLOT_TEXT }),
          h('span', { id: ID_CUSTOM_BODY, hidden: true }),
        ],
      }),
    ],
  }),
...
let HTMLBnumCardTitle = (() => {
  let _classDecorators = [
    Define({ tag: TAG_CARD_TITLE, styles: css_248z$9, template: TEMPLATE$8 }),
    UpdateAll(),
  ...
  var HTMLBnumCardTitle = class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        ...
        _onurlclick_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'onurlclick' in obj,
            get: (obj) => obj.onurlclick,
            set: (obj, value) => {
              obj.onurlclick = value;
            },
          },
          metadata: _metadata,
        },
        _onurlclick_initializers,
        _onurlclick_extraInitializers,
      );
      __esDecorate(
        this,
        null,
      ...
      __esDecorate(
        this,
        (_private__updateDOM_descriptor = {
          value: __setFunctionName(function () {
            const url = this.url;
        ...
        _private__updateDOM_decorators,
        {
          kind: 'method',
          name: '#_updateDOM',
          static: false,
          private: true,
          access: {
            has: (obj) => #_updateDOM in obj,
            get: (obj) => obj.#_updateDOM,
          },
          metadata: _metadata,
        },
        null,
    ...
    #onurlclick_accessor_storage =
      (__runInitializers(this, _private__ui_extraInitializers),
      __runInitializers(this, _onurlclick_initializers, void 0));
    get onurlclick() {
      return this.#onurlclick_accessor_storage;
    }
    set onurlclick(value) {
      this.#onurlclick_accessor_storage = value;
    }
    #url_accessor_storage =
      (__runInitializers(this, _onurlclick_extraInitializers),
      __runInitializers(this, _url_initializers, null));
    /**
     ...
     */
    get #_updateDOM() {
      return _private__updateDOM_descriptor.value;
    }
    /**
    ...
    static Generate(icon, text, link) {
      ...
      else return h(HTMLBnumCardTitle, { children: text });
    }
  };
...
let HTMLBnumFolderList = (() => {
  ...
  var HTMLBnumFolderList = class extends _classSuper {
    ...
    static Write(content = EMPTY_STRING$1, attrs = {}) {
      ...
      else return h(HTMLBnumFolderList, { children: content });
    }
  };
...
//#region Template
const TEMPLATE$7 = h(HTMLBnumFragment, {
  children: [
    h('div', {
      class: 'bal-container',
      children: [
        h('div', {
          class: 'bal-container__title',
          children: [
            h(HTMLBnumIcon, {
              class: 'bal-container__title__icon',
              children: 'square',
            }),
            h('a', {
              tabindex: '-1',
              id: 'bal-name',
              class: 'bal-container__title__name',
            }),
          ],
        }),
        h('div', {
          class: 'bal-container__left',
          children: [
            h(HTMLBnumBadge, {
              circle: true,
              class: 'bal-container__left__badge',
              children: '0',
            }),
            h(HTMLBnumButtonIcon, {
              tabindex: '-1',
              class: 'bal-container__toggle flex',
    ...
    h(HTMLBnumFolderList, {
      class: 'bal-sub-folders',
      children: h('slot', { name: 'folders' }),
    }),
  ],
});
//#endregion Template
...
let HTMLBnumFolder = (() => {
  let _classDecorators = [
    Define({ styles: css_248z$8, template: TEMPLATE$7, tag: TAG_FOLDER }),
    Observe(
      ATTR_LABEL,
      ATTR_UNREAD,
      ATTR_ICON,
  ...
  var HTMLBnumFolder = class extends _classSuper {
    ...
    _p_attach() {
      ...
      this.attr(ATTR_ROLE, VAL_ROLE_TREEITEM)
        ...
        .#_updateUnread(
          this.attr(ATTR_UNREAD) ? +this.attr(ATTR_UNREAD) : VAL_MIN_UNREAD,
        );
    }
    /**
    ...
    #_updateIsCollapsed(isCollapsed) {
      if (this.#_ui.toggle) {
        this.#_ui.toggle.icon = isCollapsed ? ICON_ARROW_DOWN : ICON_ARROW_UP;
      }
    ...
    static Write({ attributes = {}, children = [] } = {}) {
      ...
      else return h(HTMLBnumFolder, { children: childrenString });
    }
  };
...
let HTMLBnumHide = (() => {
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        ...
        __handleChange_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => '_handleChange' in obj,
            get: (obj) => obj._handleChange,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__hide_descriptor = {
          value: __setFunctionName(function () {
            this.style.display = 'none';
            this.ariaHidden = 'true';
          }, '#_hide'),
        }),
        _private__hide_decorators,
        {
          kind: 'method',
          name: '#_hide',
          static: false,
          private: true,
          access: { has: (obj) => #_hide in obj, get: (obj) => obj.#_hide },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
    ...
    #_setupListener() {
      ...
      const mode = this.getAttribute(ATTRIBUTE_MODE) || MODES.DOWN;
     ...
     */
    get #_hide() {
      return _private__hide_descriptor.value;
    }
    /**
...
//#endregion Global constants
//#region Template
const TEMPLATE$6 = h(HTMLBnumFragment, {
  children: [
    h('div', {
      class: 'group__label label-container',
      id: 'label',
      children: [
        h('div', {
          class: 'group__label--legend label-container--label',
          children: h('slot', {
            id: ID_LEGEND,
            name: 'legend',
        ...
        h('div', {
          class: 'group__label--hint label-container--hint',
          children: h('slot', {
            id: ID_HINT,
            name: 'hint',
            children: DEFAULT_HINT,
          }),
        }),
      ],
    }),
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        ...
        _private__value_initializers,
        _private__value_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__setDefaultRadioFromValue_descriptor = {
          value: __setFunctionName(function () {
            const value = this.#_value;
            if (!value) return ATresult.Ok();
          ...
          }, '#_setDefaultRadioFromValue'),
        }),
        _private__setDefaultRadioFromValue_decorators,
        {
          kind: 'method',
          name: '#_setDefaultRadioFromValue',
          static: false,
          private: true,
          access: {
            has: (obj) => #_setDefaultRadioFromValue in obj,
            get: (obj) => obj.#_setDefaultRadioFromValue,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__listenRadioChange_descriptor = {
          value: __setFunctionName(function () {
        ...
        {
          kind: 'method',
          name: '#_listenRadioChange',
          static: false,
          private: true,
          access: {
            has: (obj) => #_listenRadioChange in obj,
            get: (obj) => obj.#_listenRadioChange,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__handleKeyboardNavigation_descriptor = {
          value: __setFunctionName(function () {
            return (e) => {
              ...
              const currentIndex = currentRadio
        ...
        _private__handleKeyboardNavigation_decorators,
        {
          kind: 'method',
          name: '#_handleKeyboardNavigation',
          static: false,
          private: true,
          access: {
            has: (obj) => #_handleKeyboardNavigation in obj,
            get: (obj) => obj.#_handleKeyboardNavigation,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__handleRadioChange_descriptor = {
          value: __setFunctionName(function (e) {
            e.stopPropagation();
        ...
        _private__handleRadioChange_decorators,
        {
          kind: 'method',
          ...
          private: true,
          access: {
            has: (obj) => #_handleRadioChange in obj,
            get: (obj) => obj.#_handleRadioChange,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__scheduleSetupRadios_descriptor = {
          value: __setFunctionName(function () {
            this.#_setupRadios();
          }, '#_scheduleSetupRadios'),
        }),
        _private__scheduleSetupRadios_decorators,
        {
          kind: 'method',
          name: '#_scheduleSetupRadios',
          static: false,
          private: true,
          access: {
            has: (obj) => #_scheduleSetupRadios in obj,
            get: (obj) => obj.#_scheduleSetupRadios,
          },
          metadata: _metadata,
        },
        null,
    ...
    #_label_accessor_storage =
      (__runInitializers(this, _name_extraInitializers),
      __runInitializers(this, _private__label_initializers, EMPTY_STRING$1));
    /**
     * Le libellé du groupe.
     * @private
     */
    get #_label() {
      return _private__label_descriptor.get.call(this);
    }
    set #_label(value) {
      return _private__label_descriptor.set.call(this, value);
    }
    #_hint_accessor_storage =
      (__runInitializers(this, _private__label_extraInitializers),
      __runInitializers(this, _private__hint_initializers, EMPTY_STRING$1));
    /**
    ...
    #_value_accessor_storage =
      (__runInitializers(this, _private__hint_extraInitializers),
      __runInitializers(this, _private__value_initializers, null));
    /**
     * La valeur initiale sélectionnée du groupe.
     * @private
     */
    get #_value() {
      return _private__value_descriptor.get.call(this);
    }
    set #_value(value) {
      return _private__value_descriptor.set.call(this, value);
    }
    /**
     ...
     * @private
     */
    get #_setDefaultRadioFromValue() {
      return _private__setDefaultRadioFromValue_descriptor.value;
    }
    /**
     ...
     * @private
     */
    get #_listenRadioChange() {
      return _private__listenRadioChange_descriptor.value;
    }
    /**
     * Gère la navigation au clavier (flèches directionnelles) entre les boutons radio.
     * @private
     */
    get #_handleKeyboardNavigation() {
      return _private__handleKeyboardNavigation_descriptor.value;
    }
    /**
     ...
     * @private
     */
    get #_handleRadioChange() {
      return _private__handleRadioChange_descriptor.value;
    }
    /**
     ...
     * @private
     */
    get #_scheduleSetupRadios() {
      return _private__scheduleSetupRadios_descriptor.value;
    }
    /**
...
//#endregion Global constants
//#region Template
const TEMPLATE$5 = h('div', {
  class: 'segmented-item__container',
  id: ID_CONTAINER,
  children: [
    h(HTMLBnumIcon, { class: 'segmented-item__container__icon', id: ID_ICON }),
    h('span', {
      class: 'segmented-item__container__label',
      id: ID_LABEL,
      children: h('slot', {}),
    }),
  ],
...
let HTMLBnumSegmentedItem = (() => {
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        this,
        (_private__icon_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_icon_accessor_storage;
            },
            '#_icon',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_icon_accessor_storage = value;
            },
            '#_icon',
            'set',
          ),
        }),
        _private__icon_decorators,
        {
          kind: 'accessor',
          name: '#_icon',
          static: false,
        ...
        _private__icon_initializers,
        _private__icon_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _onSelected_decorators,
        {
          kind: 'accessor',
          name: 'onSelected',
          static: false,
          private: false,
          access: {
            has: (obj) => 'onSelected' in obj,
            get: (obj) => obj.onSelected,
            set: (obj, value) => {
              obj.onSelected = value;
            },
          },
          metadata: _metadata,
        },
        _onSelected_initializers,
        _onSelected_extraInitializers,
      );
      __esDecorate(
        this,
        null,
      ...
      __esDecorate(
        ...
        _updateLabel_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'updateLabel' in obj,
            get: (obj) => obj.updateLabel,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        ...
        _is_decorators,
        {
          ...
          static: false,
          private: false,
          access: { has: (obj) => 'is' in obj, get: (obj) => obj.is },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        ...
        _private__verifyUi_decorators,
        {
          ...
          private: true,
          access: {
            has: (obj) => #_verifyUi in obj,
            get: (obj) => obj.#_verifyUi,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        ...
        _private__setIcon_decorators,
        {
          ...
          private: true,
          access: {
            has: (obj) => #_setIcon in obj,
            get: (obj) => obj.#_setIcon,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__updateIcon_descriptor = {
          value: __setFunctionName(function (icon) {
            return this.#_verifyUi().tap(() => {
              this.#_ui.icon.icon = icon;
            });
          }, '#_updateIcon'),
        }),
        _private__updateIcon_decorators,
        {
          kind: 'method',
          name: '#_updateIcon',
          static: false,
          private: true,
          access: {
            has: (obj) => #_updateIcon in obj,
            get: (obj) => obj.#_updateIcon,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        ...
        _private__disable_decorators,
        {
          ...
          private: true,
          access: {
            has: (obj) => #_disable in obj,
            get: (obj) => obj.#_disable,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__enable_descriptor = {
          value: __setFunctionName(function () {
            if (!this.hasAttribute(ATTR_SELECTED$1)) this.#_unselect();
          }, '#_enable'),
        }),
        _private__enable_decorators,
        {
          kind: 'method',
          name: '#_enable',
          static: false,
          private: true,
          access: { has: (obj) => #_enable in obj, get: (obj) => obj.#_enable },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        ...
        _private__select_decorators,
        {
          ...
          static: false,
          private: true,
          access: { has: (obj) => #_select in obj, get: (obj) => obj.#_select },
          metadata: _metadata,
        },
        null,
        _instanceExtraInitializers,
      ...
      __esDecorate(
        this,
        (_private__unselect_descriptor = {
          value: __setFunctionName(function () {}, '#_unselect'),
        }),
        _private__unselect_decorators,
        {
          kind: 'method',
          ...
          private: true,
          access: {
            has: (obj) => #_unselect in obj,
            get: (obj) => obj.#_unselect,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__dispatchError_descriptor = {
          value: __setFunctionName(function (error) {
            return { error, caller: this };
          }, '#_dispatchError'),
        }),
        _private__dispatchError_decorators,
        {
          kind: 'method',
          name: '#_dispatchError',
          static: false,
          private: true,
          access: {
            has: (obj) => #_dispatchError in obj,
            get: (obj) => obj.#_dispatchError,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__onclick_descriptor = {
          value: __setFunctionName(function (e) {
            return { event: e, caller: this, value: this.value };
          }, '#_onclick'),
        }),
        _private__onclick_decorators,
        {
          kind: 'method',
          name: '#_onclick',
          static: false,
          private: true,
          access: {
            has: (obj) => #_onclick in obj,
            get: (obj) => obj.#_onclick,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__listenClick_descriptor = {
          value: __setFunctionName(function () {
            return this.#_onClickDisabled;
          }, '#_listenClick'),
        }),
        _private__listenClick_decorators,
        {
          kind: 'method',
          name: '#_listenClick',
          static: false,
          private: true,
          access: {
            has: (obj) => #_listenClick in obj,
            get: (obj) => obj.#_listenClick,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__listenKeyDown_descriptor = {
          value: __setFunctionName(function () {
            return this.#_onKeyDown;
          }, '#_listenKeyDown'),
        }),
        _private__listenKeyDown_decorators,
        {
          kind: 'method',
          name: '#_listenKeyDown',
          static: false,
          private: true,
          access: {
            has: (obj) => #_listenKeyDown in obj,
            get: (obj) => obj.#_listenKeyDown,
          },
          metadata: _metadata,
        },
        null,
    ...
    #selected_accessor_storage =
      (__runInitializers(this, _private__ui_extraInitializers),
      __runInitializers(this, _selected_initializers, false));
    //#endregion Private Fields
    //#region Getters/Setters
    ...
    #_icon_accessor_storage =
      (__runInitializers(this, _disabled_extraInitializers),
      __runInitializers(this, _private__icon_initializers, EMPTY_STRING$1));
    /** @attr {string} (optional) (default: '') data-icon - Nom de l'icône à afficher. */
    get #_icon() {
      return _private__icon_descriptor.get.call(this);
    }
    set #_icon(value) {
      return _private__icon_descriptor.set.call(this, value);
    }
    #onSelected_accessor_storage =
      (__runInitializers(this, _private__icon_extraInitializers),
      __runInitializers(this, _onSelected_initializers, void 0));
    /** Instance JsEvent pour la souscription aux changements de sélection. */
    get onSelected() {
      return this.#onSelected_accessor_storage;
    }
    set onSelected(value) {
      this.#onSelected_accessor_storage = value;
    }
    ...
    get #_verifyUi() {
      return _private__verifyUi_descriptor.value;
    }
    /** Configure l'icône et active l'état associé. */
    get #_setIcon() {
      return _private__setIcon_descriptor.value;
    }
    /** Met à jour la propriété icon du webcomponent bnum-icon interne. */
    get #_updateIcon() {
      return _private__updateIcon_descriptor.value;
    }
    ...
    #_updateSelected() {
      if (this.hasAttribute(ATTR_SELECTED$1)) this.#_select();
      else this.#_unselect();
      return this;
    }
    ...
    get #_disable() {
      return _private__disable_descriptor.value;
    }
    /** Désactive l'état désactivé. */
    get #_enable() {
      return _private__enable_descriptor.value;
    }
    /** Applique les attributs et états de sélection. */
    get #_select() {
      return _private__select_descriptor.value;
    }
    /** Retire les attributs et états de sélection. */
    get #_unselect() {
      return _private__unselect_descriptor.value;
    }
    ...
    get #_dispatchError() {
      return _private__dispatchError_descriptor.value;
    }
    /** Émet l'événement de sélection. */
    get #_onclick() {
      return _private__onclick_descriptor.value;
    }
     ...
     */
    get #_listenClick() {
      return _private__listenClick_descriptor.value;
    }
    /**
     ...
     */
    get #_listenKeyDown() {
      return _private__listenKeyDown_descriptor.value;
    }
    //#endregion Private Methods
    //#region Protected Methods
    /**
    ...
    static Create(value, options) {
      ...
      if (options?.OnError)
        node.addEventListener(EVT_ERROR, (e) =>
...
//#endregion Global constants
//#region Template
const TEMPLATE$4 = h('div', {
  id: 'container',
  children: [
    h('label', {
      class: 'bnum-segmented-control__legend',
      children: h('slot', {}),
    }),
    h('div', {
      class: 'bnum-segmented-control__items',
      children: [' ', h('slot', { name: 'items' })],
    }),
  ],
});
//#endregion Template
...
let HTMLBnumSegmentedControl = (() => {
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      _private__handleKeyboardNavigation_decorators = [Listen('keydown')];
      _private__onItemSelected_decorators = [
      ...
      __esDecorate(
        this,
        (_private__onItemSelected_descriptor = {
          value: __setFunctionName(function () {
        ...
        _private__onItemSelected_decorators,
        {
          ...
          private: true,
          access: {
            has: (obj) => #_onItemSelected in obj,
            get: (obj) => obj.#_onItemSelected,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        this,
        (_private__onItemSelectedAction_descriptor = {
          value: __setFunctionName(function (e) {
            const { target } = e.detail;
            if (!target) {
              this.#_onError(
                new Error(
                  "Élément cible manquant dans l'événement sélectionné.",
                ),
              );
              return;
            }
        ...
        _private__onItemSelectedAction_decorators,
        {
          kind: 'method',
          name: '#_onItemSelectedAction',
          static: false,
          private: true,
          access: {
            has: (obj) => #_onItemSelectedAction in obj,
            get: (obj) => obj.#_onItemSelectedAction,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        ...
        _private__onError_decorators,
        {
          ...
          private: true,
          access: {
            has: (obj) => #_onError in obj,
            get: (obj) => obj.#_onError,
          },
          metadata: _metadata,
        },
        null,
    ...
    #_legend_accessor_storage =
      (__runInitializers(this, _instanceExtraInitializers),
      __runInitializers(this, _private__legend_initializers, true));
    //#region Getters/Setters
    /**
     ...
     */
    get #_onItemSelected() {
      return _private__onItemSelected_descriptor.value;
    }
    /**
     ...
     * ```
     */
    get #_onItemSelectedAction() {
      return _private__onItemSelectedAction_descriptor.value;
    }
    /**
     ...
     */
    get #_onError() {
      return _private__onError_descriptor.value;
    }
    /**
...
// #endregion Global constants
//#region Template
const TEMPLATE$3 = h(HTMLBnumFragment, {
  children: [
    h('div', {
      class: CSS_CLASS_TITLE,
      children: h('slot', { name: SLOT_TITLE }),
    }),
    h('div', {
      class: CSS_CLASS_BODY,
      children: h('slot', { id: 'mainslot' }),
    }),
  ],
});
//#endregion Template
...
let HTMLBnumCardElement = (() => {
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        ...
        __titleIcon_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => '_titleIcon' in obj,
            get: (obj) => obj._titleIcon,
            set: (obj, value) => {
              obj._titleIcon = value;
            },
          },
          metadata: _metadata,
        },
        __titleIcon_initializers,
        __titleIcon_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        __titleText_decorators,
        {
          kind: 'accessor',
          name: '_titleText',
          static: false,
          private: false,
          access: {
            has: (obj) => '_titleText' in obj,
            get: (obj) => obj._titleText,
            set: (obj, value) => {
              obj._titleText = value;
            },
          },
          metadata: _metadata,
        },
        __titleText_initializers,
        __titleText_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        __titleLink_decorators,
        {
          kind: 'accessor',
          name: '_titleLink',
          static: false,
          private: false,
          access: {
            has: (obj) => '_titleLink' in obj,
            get: (obj) => obj._titleLink,
            set: (obj, value) => {
              obj._titleLink = value;
            },
          },
          metadata: _metadata,
        },
        __titleLink_initializers,
        __titleLink_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__listenClick_descriptor = {
    ...
    #_titleIcon_accessor_storage = __runInitializers(
      this,
      __titleIcon_initializers,
      EMPTY_STRING$1,
    );
     ...
     */
    get _titleIcon() {
      return this.#_titleIcon_accessor_storage;
    }
    set _titleIcon(value) {
      this.#_titleIcon_accessor_storage = value;
    }
    #_titleText_accessor_storage =
      (__runInitializers(this, __titleIcon_extraInitializers),
      __runInitializers(this, __titleText_initializers, EMPTY_STRING$1));
    /**
     * Texte du titre récupéré depuis les attributs de données du composant (`data-title-text`).
     * @private
     */
    get _titleText() {
      return this.#_titleText_accessor_storage;
    }
    set _titleText(value) {
      this.#_titleText_accessor_storage = value;
    }
    #_titleLink_accessor_storage =
      (__runInitializers(this, __titleText_extraInitializers),
      __runInitializers(this, __titleLink_initializers, EMPTY_STRING$1));
    /**
     * Lien du titre récupéré depuis les attributs de données du composant (`data-title-link`).
     * @private
     */
    get _titleLink() {
      return this.#_titleLink_accessor_storage;
    }
    set _titleLink(value) {
      this.#_titleLink_accessor_storage = value;
    }
    /**
    ...
    #_requestUpdateBody(element) {
      this.#_scheduleBody ??= new Scheduler((el) =>
    ...
    appendToTitle(element) {
      this.#_requestAppendElement(
        new ScheduleElementAppend(element, SLOT_TITLE),
      );
      return this;
    }
    /**
...
//#endregion Global constants
//#region Template
const TEMPLATE$2 = h(HTMLBnumCardElement, {
  children: [
    h(HTMLBnumCardTitle, {
      id: ID_CARD_TITLE$1,
      slot: 'title',
      'data-icon': 'today',
      children: TEXT_LAST_EVENTS,
    }),
    h(HTMLBnumCardList, {
      children: [
        h('slot', {}),
        h(HTMLBnumCardItem, {
          id: ID_CARD_ITEM_NO_ELEMENTS$1,
          disabled: true,
          hidden: true,
          children: TEXT_NO_EVENTS,
        }),
      ],
    }),
  ],
...
let HTMLBnumCardAgenda = (() => {
  let _classDecorators = [
    Define({ tag: TAG_CARD_AGENDA, styles: css_248z$3, template: TEMPLATE$2 }),
    Observe(ATTRIBUTE_LOADING$1),
  ];
  let _classDescriptor;
  let _classExtraInitializers = [];
  let _classThis;
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        ...
        _onElementChanged_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => 'onElementChanged' in obj,
            get: (obj) => obj.onElementChanged,
            set: (obj, value) => {
              obj.onElementChanged = value;
            },
          },
          metadata: _metadata,
        },
        _onElementChanged_initializers,
        _onElementChanged_extraInitializers,
      );
      __esDecorate(
        this,
        null,
      ...
      __esDecorate(
        ...
        _private__url_initializers,
        _private__url_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__max_descriptor = {
          get: __setFunctionName(
            function () {
              return this.#_max_accessor_storage;
            },
            '#_max',
            'get',
          ),
          set: __setFunctionName(
            function (value) {
              this.#_max_accessor_storage = value;
            },
            '#_max',
            'set',
          ),
        }),
        _private__max_decorators,
        {
          kind: 'accessor',
          name: '#_max',
          static: false,
        ...
        _private__max_initializers,
        _private__max_extraInitializers,
      );
      __esDecorate(
        this,
        (_private__sortChildren_descriptor = {
          value: __setFunctionName(function () {
            ...
            for (let i = 0; i < agendaItems.length - 1; i++) {
              if (
                this.#_getDate(agendaItems[i]) <
                this.#_getDate(agendaItems[i + 1])
              ) {
                isSorted = false;
                break;
              } else if (
        ...
        _private__sortChildren_decorators,
        {
          kind: 'method',
          name: '#_sortChildren',
          static: false,
          private: true,
          access: {
            has: (obj) => #_sortChildren in obj,
            get: (obj) => obj.#_sortChildren,
          },
          metadata: _metadata,
        },
        null,
    ...
    #onElementChanged_accessor_storage =
      (__runInitializers(this, _private__ui_extraInitializers),
      __runInitializers(this, _onElementChanged_initializers, void 0));
    /**
     * Déclenché lorsque les éléments changent (ajout/suppression).
     */
    get onElementChanged() {
      return this.#onElementChanged_accessor_storage;
    }
    set onElementChanged(value) {
      this.#onElementChanged_accessor_storage = value;
    }
    #loading_accessor_storage =
      (__runInitializers(this, _onElementChanged_extraInitializers),
      __runInitializers(this, _loading_initializers, false));
    get loading() {
      return this.#loading_accessor_storage;
    }
    set loading(value) {
      this.#loading_accessor_storage = value;
    }
    #_url_accessor_storage =
      (__runInitializers(this, _loading_extraInitializers),
      __runInitializers(this, _private__url_initializers, EMPTY_STRING$1));
    get #_url() {
      return _private__url_descriptor.get.call(this);
    }
    set #_url(value) {
      return _private__url_descriptor.set.call(this, value);
    }
    #_max_accessor_storage =
      (__runInitializers(this, _private__url_extraInitializers),
      __runInitializers(this, _private__max_initializers, void 0));
    get #_max() {
      return _private__max_descriptor.get.call(this);
    }
    set #_max(value) {
      return _private__max_descriptor.set.call(this, value);
    }
    get #_cardPart() {
      if (this.#_card === null) {
        this.#_card =
    ...
    set max(value) {
      ...
      if (this.alreadyLoaded) {
        if (value === null) this.#_showAllItems(items);
        else this.#_hideMax(items);
      }
    }
    //#endregion Getters/Setters
    //#region Lifecycle
    ...
    _p_attach() {
      ...
      if (this.loading) this.#_setLoading();
    }
    _p_update(name, _, newVal) {
      switch (name) {
        case ATTRIBUTE_LOADING$1:
          ...
          else this.#_setLoading({ attributeValue: newVal });
          break;
      }
    }
    //#endregion Lifecycle
     ...
     */
    get #_sortChildren() {
      return _private__sortChildren_descriptor.value;
    }
    #_hideMax(agendaItems) {
      ...
      for (let index = 0, len = agendaItems.length; index < len; ++index) {
        ...
        if (element.hasClass('last')) element.removeClass('last');
        if (index >= this.max) element.hidden = true;
        else {
          element.hidden = false;
          if (index === this.max - 1) element.addClass('last');
        }
      }
    }
    ...
    static Create({ contents = [], url = EMPTY_STRING$1 } = {}) {
      const node = document.createElement(this.TAG);
      if (url !== EMPTY_STRING$1) node.setAttribute(ATTRIBUTE_DATA_URL$1, url);
...
var css_248z$2 =
  ':host{--main-content-max-width:80%;display:var(--bnum-card-email-display,block)}[hidden]{display:none}';
...
//#endregion Global constants
//#region Template
const TEMPLATE$1 = h(HTMLBnumCardElement, {
  children: [
    h(HTMLBnumCardTitle, {
      id: ID_CARD_TITLE,
      slot: 'title',
      'data-icon': 'mail',
      children: TEXT_LAST_MAILS,
    }),
    h(HTMLBnumCardList, {
      children: [
        h('slot', {}),
        h(HTMLBnumCardItem, {
          id: ID_CARD_ITEM_NO_ELEMENTS,
          disabled: true,
          hidden: true,
          children: TEXT_NO_MAILS,
        }),
      ],
    }),
  ],
...
let HTMLBnumCardEmail = (() => {
  let _classDecorators = [
    Define({ tag: TAG_CARD_EMAIL, styles: css_248z$2, template: TEMPLATE$1 }),
  ...
  (class extends _classSuper {
        ...
        (_private__sortChildren_descriptor = {
          value: __setFunctionName(function () {
            ...
            for (let i = 0; i < mailItems.length - 1; i++) {
              if (
                this.#_getDate(mailItems[i]) < this.#_getDate(mailItems[i + 1])
              ) {
                isSorted = false;
                break;
              }
    ...
    static Create({ contents = [], url = EMPTY_STRING$1 } = {}) {
      const node = document.createElement(this.TAG);
      if (url !== EMPTY_STRING$1) node.setAttribute(ATTRIBUTE_DATA_URL, url);
      if (contents.length > 0) node.add(...contents);
      return node;
    }
    /**
...
const TEMPLATE = h('div', {
  class: CLASS_HEADER_MODIFIER,
  part: CLASS_HEADER_MODIFIER,
  children: h('div', {
    part: PART_HEADER_CONTAINER,
    class: CLASS_HEADER_CONTAINER,
    children: [
      h('div', {
        part: PART_HEADER_LEFT,
        class: CLASS_HEADER_LEFT,
        children: [
          h(HTMLBnumHide, {
            breakdown: 'touch',
            mode: 'up',
            children: h(HTMLBnumButtonIcon, { id: 'menu', children: 'menu' }),
          }),
          h('slot', { name: SLOT_NAME_LOGO }),
          h(HTMLBnumHide, {
            breakdown: 'touch',
            children: [
              h('slot', { name: SLOT_NAME_TITLE }),
              h('h1', {
      ...
      h('div', {
        part: PART_HEADER_RIGHT,
        class: CLASS_HEADER_RIGHT,
        children: [
          h('slot', { name: SLOT_NAME_ACTIONS }),
          h('slot', { name: SLOT_NAME_AVATAR }),
        ],
      }),
    ],
  }),
...
let HTMLBnumHeader = (() => {
  let _classDecorators = [
    Define({ tag: TAG_HEADER, styles: css_248z$1, template: TEMPLATE }),
  ];
  let _classDescriptor;
  let _classExtraInitializers = [];
  let _classThis;
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      _onBackgroundChanged_decorators = [
      ...
      __esDecorate(
        ...
        {
          kind: 'accessor',
          name: 'onBackgroundChanged',
          static: false,
          private: false,
          access: {
            has: (obj) => 'onBackgroundChanged' in obj,
            get: (obj) => obj.onBackgroundChanged,
            set: (obj, value) => {
              obj.onBackgroundChanged = value;
            },
          },
          metadata: _metadata,
        },
        _onBackgroundChanged_initializers,
        _onBackgroundChanged_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _onMenuClick_decorators,
        {
          kind: 'accessor',
          name: 'onMenuClick',
          static: false,
          private: false,
          access: {
            has: (obj) => 'onMenuClick' in obj,
            get: (obj) => obj.onMenuClick,
            set: (obj, value) => {
              obj.onMenuClick = value;
            },
          },
          metadata: _metadata,
        },
        _onMenuClick_initializers,
        _onMenuClick_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _imgBackground_decorators,
        {
          kind: 'accessor',
          name: 'imgBackground',
          static: false,
          private: false,
          access: {
            has: (obj) => 'imgBackground' in obj,
            get: (obj) => obj.imgBackground,
            set: (obj, value) => {
              obj.imgBackground = value;
            },
          },
          metadata: _metadata,
        },
        _imgBackground_initializers,
        _imgBackground_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        _breakpoints_decorators,
        {
          kind: 'accessor',
          name: 'breakpoints',
          static: false,
          private: false,
          access: {
            has: (obj) => 'breakpoints' in obj,
            get: (obj) => obj.breakpoints,
            set: (obj, value) => {
              obj.breakpoints = value;
            },
          },
          metadata: _metadata,
        },
        _breakpoints_initializers,
        _breakpoints_extraInitializers,
      );
      __esDecorate(
        this,
        null,
        __handleMenuClicked_decorators,
        {
          kind: 'method',
          name: '_handleMenuClicked',
          static: false,
          private: false,
          access: {
            has: (obj) => '_handleMenuClicked' in obj,
            get: (obj) => obj._handleMenuClicked,
          },
          metadata: _metadata,
        },
        null,
    ...
    #onBackgroundChanged_accessor_storage =
      (__runInitializers(this, _private__ui_extraInitializers),
      __runInitializers(this, _onBackgroundChanged_initializers, void 0));
    /**
     * Evènement du changement d'image de fond
     */
    get onBackgroundChanged() {
      return this.#onBackgroundChanged_accessor_storage;
    }
    set onBackgroundChanged(value) {
      this.#onBackgroundChanged_accessor_storage = value;
    }
    #onMenuClick_accessor_storage =
      (__runInitializers(this, _onBackgroundChanged_extraInitializers),
      __runInitializers(this, _onMenuClick_initializers, void 0));
    /**
     * Evènement au click sur le menu
     */
    get onMenuClick() {
      return this.#onMenuClick_accessor_storage;
    }
    set onMenuClick(value) {
      this.#onMenuClick_accessor_storage = value;
    }
    #imgBackground_accessor_storage =
      (__runInitializers(this, _onMenuClick_extraInitializers),
      __runInitializers(this, _imgBackground_initializers, null));
    /**
     * Données de l'image de fond
     */
    get imgBackground() {
      return this.#imgBackground_accessor_storage;
    }
    set imgBackground(value) {
      this.#imgBackground_accessor_storage = value;
    }
    #breakpoints_accessor_storage =
      (__runInitializers(this, _imgBackground_extraInitializers),
      __runInitializers(this, _breakpoints_initializers, true));
    /**
     * Si on active les changements en mode mobile ou non
     */
    get breakpoints() {
      return this.#breakpoints_accessor_storage;
    }
    set breakpoints(value) {
      this.#breakpoints_accessor_storage = value;
    }
    /**
     * Scheduler pour la mise à jour de l'image de fond
     */
    ...
    static Create({ background = null } = {}) {
      return document
        .createElement(this.TAG)
        .condAttr(background !== null, `data-${DATA_BACKGROUND}`, background);
    }
  });
  return _classThis;
})();
...
var css_248z =
  '@keyframes rotate360{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}bnum-tree{display:block}bnum-tree:focus{position:relative}';
  ...
  (class extends _classSuper {
    ...
    static {
      ...
      __esDecorate(
        this,
        null,
        _static_TryIncludeStyle_decorators,
        {
          kind: 'method',
          name: 'TryIncludeStyle',
          static: true,
          private: false,
          access: {
            has: (obj) => 'TryIncludeStyle' in obj,
            get: (obj) => obj.TryIncludeStyle,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        ...
        __handleSelection_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => '_handleSelection' in obj,
            get: (obj) => obj._handleSelection,
          },
          metadata: _metadata,
        },
        null,
      ...
      __esDecorate(
        ...
        __handleKeyDown_decorators,
        {
          ...
          private: false,
          access: {
            has: (obj) => '_handleKeyDown' in obj,
            get: (obj) => obj._handleKeyDown,
          },
          metadata: _metadata,
        },
        null,
    ...
    _handleKeyDown(e) {
      ...
      if (!this.#_focusedItem?.isConnected) this.#_focusedItem = null;
      if (!current) return;
...
let HTMLBnumColumn = (() => {
  ...
  (class extends _classSuper {
    ...
    _p_buildDOM(container) {
      ...
      this.classList.add(
        CLASSES.HOST,
        `${CLASSES.CONTENT_PREFIX}--${this.type}`,
      );
