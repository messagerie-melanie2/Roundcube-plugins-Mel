...
import {
  ...
  m_mail_get_favorites_colors,
  m_mail_get_favorites_icons,
} from './functions.js';
export { connectors as Connectors };

const connectors = {
  settings_da_get_email_recup: new Connector(
    'settings',
    'plugin.mel.doubleauth.get',
    { params: { _prop: 'double_authentification_adresse_recuperation' } },
  ),
  settings_da_get_email_valid: new Connector(
    'settings',
    'plugin.mel.doubleauth.get',
    { params: { _prop: 'double_authentification_adresse_valide' } },
  ),
  settings_da_set_email_recup: new Connector(
    'settings',
    'plugin.mel.doubleauth.set',
    {
      type: Connector.enums.type.post,
      params: { _prop: 'double_authentification_adresse_recuperation' },
      needed: { _val: 'email', _send_mail: true },
      postProcess: settings_da_set_email_recup,
    },
  ),
  settings_da_set_token_otp: new Connector(
    'settings',
    'plugin.mel.doubleauth.verify_code',
    {
      type: Connector.enums.type.post,
      needed: { _token: 'token' },
    },
  ),
  settings_da_send_otp_token: new Connector(
    'settings',
    'plugin.mel.doubleauth.send_otp',
    { type: Connector.enums.type.post },
  ),
  settings_da_get_recovery_code_max: new Connector(
    'settings',
    'plugin.mel.doubleauth.get',
    { params: { _prop: 'NUMBER_RECOVERY_CODES' } },
  ),

  mail_toggle_favorite: new Connector(
    'mail',
    'plugin.mel_metapage.toggle_favorite',
    {
      type: Connector.enums.type.post,
  ...
  mail_set_folder_color: new Connector(
    'mail',
    'plugin.mel_metapage.set_folder_color',
    {
      type: Connector.enums.type.post,
