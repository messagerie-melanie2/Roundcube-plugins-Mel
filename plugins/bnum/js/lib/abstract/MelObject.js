...
export { MelObject };
import { Mel_Ajax, Mel_Promise } from '../mel_promise.js';
import { RcubeObject } from './RcubeObject.js';
 ...
 */
class MelObject extends RcubeObject {
  /**
   ...
   * @param {import('../mel_promise.js').MelPromiseCallback} callback Peut être asynchrone. Fonction qui sera appelé.
   ...
   * @param {import('../mel_promise.js').WaitCallback | import('../mel_promise.js').WaitCallbackAsync} callback Function qui est appelé à chaque tick. Lorsque "true" est renvoyé, la boucle s'arrête
   * @param {Object} [options={}]
